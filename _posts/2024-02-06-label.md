...
| 样例 | 标注结果(,分割) | 平均标注耗时 | 质检结果 | 最终标签 |
| --- | --- | --- | --- | --- |
| **太阳出来了吗** | 积极,积极,积极,积极 | 0.57 | Yes | <font style='color:red'>积极</font> |
| **怎么这么慢** | 消极,消极,消极,消极 | 0.46 | Yes | <font style='color:green'>消极</font> |
| **你客气了** | 中性,积极,积极,积极 | 0.45 | Sure | <font style='color:red'>积极</font> |
...
| 样例 | 标注结果(,分割) | 平均标注耗时 | 质检结果 | 最终标签 |
| --- | --- | --- | --- | --- |
| **太阳出来了吗** | 中性,中性,中性,中性 | 1.30 | Yes | <font style='color:green'>中性</font> |
| **怎么这么慢** | 消极,消极,消极,消极 | 0.92 | Yes | <font style='color:green'>消极</font> |
| **你客气了** | 中性,中性,中性,中性 | 1.02 | Yes | <font style='color:green'>中性</font> |
