...
categories: 读书笔记
tags: 大脑 第二大脑 本我 自我 超我 心理学 睡眠 意识 欲望 system 系统
...
人类信息处理速度仅为 10 bit/s，而感官系统却能以 10亿bit/s 的速率收集数据。

按照每秒10bit的速度来算，人类24小时不间断学习且不遗忘，100年储存的知识也不过**4GB**。

大语言模型每个参数就能存储2bit知识，一个70亿参数的模型就能存储140亿bit的知识。

为什么人类信息处理速度这么慢?
- 中枢神经系统在处理信息时采用的是**串行**方式，对信息传输速率有所限制。
  - “心理不应期”（psychological refractory period）效应，即同时面对多个任务，中枢神经系统只将注意力集中在一个任务上。
- “注意瓶颈” 等限制了信息处理。

马斯克的大脑与计算机的通信速率大约为10bit/s。与其使用Neuralink的电极束，不如直接使用电话，因为电话的数据传输率已经被设计得与人类语言相匹配，而人类语言又与感知和认知的速度相匹配。
