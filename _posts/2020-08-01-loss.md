...
数学定义
- [参考](https://ky.tqkhn.love/math/gaoshu/c01/1.0.html)
...
- PyTorch实现源码: [Class-balanced-loss-pytorch](https://github.com/vandit15/Class-balanced-loss-pytorch)
