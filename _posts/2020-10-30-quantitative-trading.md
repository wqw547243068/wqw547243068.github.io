...
- 【2025-10-6】[Alpha 因子与量化交易：入门黑话解释](https://zhuanlan.zhihu.com/p/1958396800630253463)
...
[量化交易入门：小市值策略研究](https://zhuanlan.zhihu.com/p/632686860)
...
小市值策略的理论模型步骤：
1. 选择小市值公司：根据市值大小和其他基本面指标，筛选出市值较小、但具有较高成长性和投资价值的公司。
2. 进行基本面分析：对选定的小市值公司进行财务和业务分析，评估其成长性和投资价值。
3. 进行市场行为分析：对市场供求关系、投资者情绪和预期等因素进行分析，预测市场走势和趋势。
4. 制定投资策略：根据基本面分析和市场行为分析的结果，制定适合自己的投资策略和组合。
5. 风险控制和资金管理：注意风险控制和资金管理，选择适合自己的投资组合和策略。
...
【2026-5-31】[嘿嘿我是静静啊](https://www.xiaohongshu.com/explore/6a1ac212000000003601f975): 辞职全职炒股，需要关注的五位财经博主，帮助自己实现了财务自由。
...
[2026年量化框架终极对决：QLib、QuantConnect、Zipline](https://www.toutiao.com/article/7607810861863830026/)
...
【2025-8-2】清华全球首个 K 线大模型 [Kronos](https://shiyu-coder.github.io/Kronos-demo/)，免费开源笔记本就能跑，改写交易玩法
- 论文 [Kronos: A Foundation Model for the Language of Financial Markets](https://arxiv.org/pdf/2508.02739)
- 解读 [国内首个开源金融K线基础模型Kronos](https://zhuanlan.zhihu.com/p/1949595937723885447)
- 应用：[Kronos+miniQMT预测股票](https://juejin.cn/post/7560167720013692974)
...
- 论文：[AlphaAgentEvo: Evolution-Oriented Alpha Mining via Self-Evolving Agentic Reinforcement Learning](https://iclr.cc/virtual/2026/poster/10007685)
...
- ![](https://pic2.zhimg.com/v2-8f8781a1304e03b26beb198af3a9256f_1440w.jpg)

### XQuant 教程

【2026-6-21】[XQuant](https://xingwudao.github.io/xquant-beginner)：人人都是量化交易员

开源量化交易入门教程（目前为书稿形式），由 xingwudao（邢无刀） 编写并持续迭代。采用 VitePress 构建，在线阅读体验极佳，内容完全免费。
核心价值在于极其实践导向：
- 从「跑通第一个策略」开始，一步步选资产（从 3 只 ETF 起步）、决定仓位分配、设置再平衡/止损止盈
- 如何判断策略好不好、如何防止过拟合
- 最后实盘执行、监控诊断、迭代优化
- 最后引入因子研究入门，持续发现新机会
整本书像一本「量化交易实操手册」，而不是空谈理论。配套还有独立练习仓库（含代码和 notebook），读完就能动手练。

### 【2026-7-1】go-stock

【2026-7-1】[go-stock](https://github.com/arvinlovegood/go-stock)：支持 A 股、港股、美股牛逼的仓库 
...
### 【2026-8-28】港大 Vibe-Trading

【2026-8-28】港大团队开源的 [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading)， 一句话让LLM变身专业交易员

只需要用大白话描述交易想法，系统就会自动拉取多市场数据、生成策略、跑回测，最后输出完整的诊断报告。

几个硬核能力：
- 影子账户：上传个人交易流水，AI自动拆解你的行为模式、提炼规则、生成对应的影子策略，还能对比实际盈亏、持仓周期和错失的信号，一键出审计报告。
- 多市场智能回测：覆盖A股、港股、美股、加密货币和期货，整合18个数据源并自带防封切换，内置456个因子一键跑基准测试。
- 29个多智能体协作团：包括投资委员会、量化分析组、风控小组等，协同输出带证据链的研究结论。
- 多渠道实时推送：打通Telegram、微信、Discord等16个通道，研究成果第一时间送达。
- 安全至上：只读连接、紧急终止开关、全程操作审计，绝不碰你的实盘资金。

无论复盘、研究还是验证新策略，都值得一试。
...
### 【2026-8-28】daily_stock_analysis 股市分析

【2026-8-28】[daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis)，LLM驱动的多市场股票智能分析系统，把A股、港股、美股、日股、韩股、台股和ETF全都包进去了。
- 聚多源行情、扒实时新闻、生成决策看板，最后把分析结果自动甩到 飞书/微信、TG、Dc、Slack或者邮箱里。

核心的是AI决策报告：
- 每只股票都给你打分、判趋势、给买卖参考、发风险警报、拎利好因素、列操作清单。
- 还支持Agent策略问股，内置了均线、缠论、波浪、趋势、事件驱动等15种玩法，在Web界面上可以来回追问。

靠 GitHub Actions就能零成本定时跑，5分钟搞定配置，每个工作日自动干活。
