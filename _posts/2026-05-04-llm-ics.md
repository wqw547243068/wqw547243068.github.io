...
|[customer-chatbot-solution-accelerator](https://github.com/microsoft/customer-chatbot-solution-accelerator)|2025年9月|微软|Foundry agent框架在电商客服上实践|低|依赖微软生态|
|[openai-cs-agents-demo](https://github.com/openai/openai-cs-agents-demo)|2025年12月|OpenAI|multi-agent架构实现的航空订票客服|低|基于OpenAI自己的生态（Agent+ChatKit）|
