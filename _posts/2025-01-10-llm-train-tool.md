...
ms-swift 
- 采用最新的训练技术，包括 LoRA、QLoRA、Llama-Pro、LongLoRA、GaLore、Q-GaLore、LoRA+、LISA、DoRA、FourierFt、ReFT、UnSloth 和 Liger 等轻量级技术，以及 DPO、GRPO、RM、PPO、KTO、CPO、SimPO 和 ORPO 等人工对齐训练方法。
...
- Swift 提供了丰富的工具箱能力，包括推理加速引擎（如 vLLM、LmDeploy）和全面的模型评测体系（EvalScope）。开发者可以通过简单的接口实现模型训练、推理、评测和部署，甚至支持多种 tuner 的混合使用。
