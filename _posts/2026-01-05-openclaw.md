...
categories: 大模型
tags: openclaw 龙虾 hermes agent 设计模式 openhuman multica agent loop claude codex 美团
...
【2026-8-18】[美团养虾运动反思](https://mp.weixin.qq.com/s/YmCNKhLsGCdl_9xnvHC10Q)

美团核心本地商业CEO`王莆中`在公开演讲中表示，当前AI供给看似充足，真正能统计到可测量收益的企业却寥寥无几。

多数公司的AI投入，仍停留在热闹但无效的阶段。

`王莆中`将企业AI落地难的核心症结，总结为**四重错配**。
- **认知**层面，企业对AI的态度走向两个极端，要么无限夸大其能力，预期远超技术边界；要么轻视其长期价值，视作可有可无的工具。
- **效率**层面，大模型多被用于处理日常事务性工作，未能真正触及业务核心环节，产出的多是 “锦上添花” 的边际提效。
- **场景**层面，AI应用始终游走在经营边缘，客服、文案、代码辅助等场景遍地开花，却很少深入供应链、定价、运营等核心经营链路。
- **考核**层面，企业普遍追求立竿见影的效果，忽视内部组织适配与流程改造的周期，短期看不到回报便轻易放弃。

四重错配相互叠加，最终导致AI投入难以转化为可量化的生产力增长

美团的AI变革共走过四个阶段。
- 今年2到3月为第一阶段，公司开启全员养虾运动，鼓励所有员工大胆尝试大模型工具。热情迅速被点燃，但问题也随之而来。
  - 算力账单一路暴涨，更棘手，模型生成的错误信息混入真实业务流程，反而对正常经营造成了干扰。
- 进入4月，美团进入第二阶段。各事业部相继成立专门的AI组织，从散点式尝试转向有组织的推进。公司开始沉淀可复用的转型方法，试图将全员的积极性有序转化为实际生产力。
- 6至7月是关键的第三阶段。美团通过内部赛马机制，对不同路径的AI落地方法进行筛选验证，最终得出一个关键认知。
  - AI转型本质上不是技术问题，不能只寄望于产研团队单打独斗，必须让业务部门深度参与，同步调整组织流程与考核方式，技术才能真正嵌入经营环节。
- 到了7月，美团AI变革进入第四阶段，AI能力初步在内部产品流程中跑通，并开始产生可验证的业务价值。

从全员狂欢到成本失控，再到组织调整、体系化落地，美团用半年时间走完了一条从感性到理性的AI落地路径。

美团的经历并非个例。

近期，国内头部互联网公司不约而同收紧了内部员工的Token使用额度。
- 腾讯率先调整内部Token分配机制，从最初的全员统一高额配额，改为按岗位、按任务动态调配，核心岗位保障供给，普通岗位收紧额度。
- 字节跳动对自研模型保持免费开放，但外部模型调用费用改为部门按比例承担。
- 阿里、京东也相继出台类似政策，将Token从全员福利转变为部门可控的预算资产。

海外科技公司动作更早
- Uber四个月便花完全年AI预算
- Meta下线了内部的Token 消耗排行榜，微软则缩减了部分员工的AI工具权限。

这一轮集体降温，背后是算力成本的现实压力。大模型推理成本远超行业初期预期，一次复杂任务的调用成本可达数美元，全员无节制使用带来的账单规模惊人。

当狂热褪去，企业开始正视一个基本问题，AI投入必须对应明确的业务产出，而非单纯比拼调用量。
