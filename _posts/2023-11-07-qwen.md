...
categories: 大模型
tags: GPT qwen 多模态 目标检测 阿里云 百炼 训练 全模态 搜索 多模态诅咒
excerpt: 开源大模型笔记
mathjax: true
permalink: /qwen
---
...
- 参考 [一文读懂 Qwen 模型命名体系：从混乱到清晰](https://mp.weixin.qq.com/s/N0a5jSplB4-PHBIIxVIIQg)
...
但现实是通用智能还没到那一步，于是采用更务实的策略：先**分治**，再**融合**。
...
|---|---|---|---|---|---|---|
|家族1：LLM 系列（语言大模型）|Qwen3-xB-AyB-Instruct|Qwen3-235B-A22B-Instruct|xB：总参数量<br>AyB：激活参数量（MoE 专家模型）|Instruct：对话
<br>Thinking：推理<br>无后缀：混合类型（既能聊，又能想）|小幅更新时会加时间后缀，如 Qwen3-235B-A22B-Instruct-2507|Qwen3 起，通义全面切换到 MoE（混合专家）架构，命名多了 AyB。老版本稠密模型没有这段|
...
|分支1：Image 系列（图像生成模型）|Qwen-Image / Qwen-Image-Edit|||||注意：<br>不带版本号（没有 Qwen3-Image 这种叫法）<br>基于扩散模型，不走 Transformer 路线<br>目前只发布了一个主力模型|
|分支2：Audio 系列（语音模型）|Qwen3-ASR：语音识别<br>Qwen3-TTS：文本转语音|||||API 已上线 Qwen3-ASR-Flash，开源版本还在路上|
...
- 2023年4月11日，阿里云峰会正式发布通义千问 `Qwen1`（闭源内测版，基座原型）
  - 阿里所有产品将接入`通义千问`大模型，全面改造，包括天猫、钉钉、高德地图、淘宝、优酷、盒马等 ；
...
行业信号：
- 大厂AI团队正普遍从**实验室**走向**业务线**，技术负责人话语权让位商业与产品负责人，顶尖AI人才出走将成常态。
...
【2025-12-28】[Qwen（千问）大模型负责人林俊旸的技术成就](https://mp.weixin.qq.com/s/BZNg_ImF3WadjZkzHCIyvA)
...
- 第三，多模态的一体化设计。 得益于`M6`、`OFA`的积累，Qwen从一开始就是多模态模型家族：`Qwen-VL`理解图像，`Qwen-Audio`理解语音，`Qwen-Omni`图文声统一处理
...
四代演进核心脉络
1. `Qwen1` → `Qwen1.5`→ `Qwen2`：稠密架构的成熟期, 如何在有限显存下支持更长上下文？​注意力机制的显存优化
  - Qwen1 采用标准的 MHA（多头注意力），每个 token 的 KV Cache 需要存储所有头的键值对，显存占用随序列长度线性增长。
...
2. `Qwen2` → `Qwen2.5`→ `Qwen3`：MoE 架构的探索期, 上下文从32K扩至128K，数学/代码/结构化能力显著增强，闭源推出MoE版API。
  - `Qwen2` 首次引入MoE架构（57B-A14B，160 专家选 6），但保留了共享专家作为“安全网”;上下文扩至256K，评测全面追赶闭源模型，Thinking能力初步成型。
  - Qwen3 则进行了大胆实验：移除共享专家，完全依赖 128 个路由专家，并引入全局批次负载均衡替代传统的每层辅助损失。
  - 这一阶段的标志性成果是MoE 激活率降至个位数（Qwen3 为 9.4%，Qwen3.5 为 8.5%），证明了极致的稀疏化不会损害模型能力。
3. `Qwen3.5` → `Qwen3.6` ：混合注意力的革命期,如何让百万级上下文成为原生能力而非外推技巧？​计算复杂度的线性化
  - MoE专家扩容4倍+共享专家，原生多模态统一预训练，Thinking默认深度思考，评测全面超越GPT-5.2/Claude 4.5，成为开源新标杆。
...
4. `Qwen3.6` → `Qwen3.7`：Agentic 能力的内化期, 如何让模型从“响应指令”变为“自主规划”？​智能体能力的架构内生化。
  - Qwen3.6 系列不再将 Function Calling、Tool Use 视为后训练技巧，而是通过三阶段预训练和四阶段 RL 将其内化为模型本能。
...
参考
- 【2026-3-3】[Qwen 三代进化全景对比：从 Qwen2.5 到 Qwen3 再到 Qwen3.5](https://blog.csdn.net/m0_47999117/article/details/158609371)
- 【2026-6-2】[Qwen 演进全景：从单一稠密模型到原生智能体生态的四次范式跃迁](https://zhuanlan.zhihu.com/p/2040064312522299329)



<!-- draw.io diagram -->
<div class="mxgraph" style="max-width:100%;border:1px solid transparent;" data-mxgraph="{&quot;highlight&quot;:&quot;#0000ff&quot;,&quot;nav&quot;:true,&quot;resize&quot;:true,&quot;dark-mode&quot;:&quot;auto&quot;,&quot;toolbar&quot;:&quot;zoom layers tags lightbox&quot;,&quot;edit&quot;:&quot;_blank&quot;,&quot;xml&quot;:&quot;&lt;mxfile host=\&quot;app.diagrams.net\&quot;&gt;\n  &lt;diagram name=\&quot;Qwen四代演进\&quot; id=\&quot;eMoWEZYMmT8u7dPpwd27\&quot;&gt;\n    &lt;mxGraphModel dx=\&quot;941\&quot; dy=\&quot;660\&quot; grid=\&quot;1\&quot; gridSize=\&quot;10\&quot; guides=\&quot;1\&quot; tooltips=\&quot;1\&quot; connect=\&quot;1\&quot; arrows=\&quot;1\&quot; fold=\&quot;1\&quot; page=\&quot;1\&quot; pageScale=\&quot;1\&quot; pageWidth=\&quot;827\&quot; pageHeight=\&quot;1169\&quot; math=\&quot;0\&quot; shadow=\&quot;0\&quot;&gt;\n      &lt;root&gt;\n        &lt;mxCell id=\&quot;0\&quot; /&gt;\n        &lt;mxCell id=\&quot;1\&quot; parent=\&quot;0\&quot; /&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-36\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=none;strokeWidth=3;dashed=1;dashPattern=1 1;\&quot; value=\&quot;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;250\&quot; width=\&quot;220\&quot; x=\&quot;60\&quot; y=\&quot;440\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-19\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=none;fillStyle=solid;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent; color: light-dark(rgb(0, 0, 0), rgb(255, 255, 255));&amp;quot;&amp;gt;模型规模：0.5B~72B&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;220\&quot; x=\&quot;160\&quot; y=\&quot;450\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-37\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=none;strokeWidth=3;dashed=1;dashPattern=1 1;\&quot; value=\&quot;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;350\&quot; width=\&quot;430\&quot; x=\&quot;280\&quot; y=\&quot;220\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-42\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=none;strokeWidth=3;dashed=1;dashPattern=1 1;\&quot; value=\&quot;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;245\&quot; width=\&quot;320\&quot; x=\&quot;1210\&quot; y=\&quot;125\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-40\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=none;strokeWidth=3;dashed=1;dashPattern=1 1;\&quot; value=\&quot;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;220\&quot; width=\&quot;320\&quot; x=\&quot;870\&quot; y=\&quot;170\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-1\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=#647687;strokeColor=#314354;fontSize=26;shadow=1;glass=0;fontStyle=1;fontColor=#ffffff;\&quot; value=\&quot;Qwen2\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;110\&quot; x=\&quot;215\&quot; y=\&quot;490\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-2\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=#a0522d;strokeColor=#6D1F00;fontSize=26;shadow=1;glass=0;fontStyle=1;fontColor=#ffffff;\&quot; value=\&quot;Qwen2.5&amp;amp;nbsp;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;50\&quot; width=\&quot;120\&quot; x=\&quot;360\&quot; y=\&quot;430\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-3\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=#a0522d;strokeColor=#6D1F00;fontSize=26;shadow=1;glass=0;fontStyle=1;fontColor=#ffffff;\&quot; value=\&quot;Qwen3&amp;amp;nbsp;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;55\&quot; width=\&quot;124.5\&quot; x=\&quot;620\&quot; y=\&quot;357.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-4\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=#1ba1e2;strokeColor=#006EAF;fontSize=26;shadow=1;glass=0;fontStyle=1;fontColor=#ffffff;\&quot; value=\&quot;Qwen3.5&amp;amp;nbsp;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;70\&quot; width=\&quot;130\&quot; x=\&quot;900\&quot; y=\&quot;270\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-5\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; source=\&quot;vIzsuBNDGU4je8Ju_WXj-1\&quot; style=\&quot;html=1;endArrow=block;strokeWidth=4;fontSize=19;fontStyle=1;fontColor=#808080;strokeColor=#999999;\&quot; target=\&quot;vIzsuBNDGU4je8Ju_WXj-2\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; x=\&quot;0.8985\&quot; y=\&quot;52\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint as=\&quot;offset\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-6\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; source=\&quot;vIzsuBNDGU4je8Ju_WXj-2\&quot; style=\&quot;html=1;endArrow=block;strokeWidth=4;fontSize=19;fontStyle=1;fontColor=#808080;strokeColor=#999999;\&quot; target=\&quot;vIzsuBNDGU4je8Ju_WXj-3\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; x=\&quot;0.326\&quot; y=\&quot;48\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint as=\&quot;offset\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-7\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; source=\&quot;vIzsuBNDGU4je8Ju_WXj-3\&quot; style=\&quot;html=1;endArrow=block;strokeWidth=4;fontSize=19;fontStyle=1;fontColor=#808080;strokeColor=#999999;\&quot; target=\&quot;vIzsuBNDGU4je8Ju_WXj-4\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; x=\&quot;-0.1336\&quot; y=\&quot;33\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint as=\&quot;offset\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-9\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=#f5f5f5;fillStyle=solid;labelBackgroundColor=none;fontColor=#333333;strokeColor=#666666;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸上下文：32K→128K&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸数学/代码/结构化增强&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸验证MoE长文本能力&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;闭源上线 MoE-API&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;110\&quot; width=\&quot;220\&quot; x=\&quot;360\&quot; y=\&quot;480\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-10\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=#f5f5f5;fillStyle=solid;labelBackgroundColor=none;fontColor=#333333;strokeColor=#666666;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;color: light-dark(rgb(0, 0, 0), rgb(237, 237, 237)); text-align: center; background-color: transparent;&amp;quot;&amp;gt;▸上下文扩容至256K&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸推理Thinking初步成型&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent; color: light-dark(rgb(0, 0, 0), rgb(255, 255, 255));&amp;quot;&amp;gt;▸首代MoE架构落地,移除共享专家&amp;lt;/span&amp;gt;&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸评测对标头部闭源&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;105\&quot; width=\&quot;303.5\&quot; x=\&quot;500\&quot; y=\&quot;235\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-11\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=#f5f5f5;fillStyle=solid;labelBackgroundColor=none;fontColor=#333333;strokeColor=#666666;align=left;\&quot; value=\&quot;&amp;lt;div style=&amp;quot;&amp;quot;&amp;gt;&amp;lt;font color=&amp;quot;#000000&amp;quot;&amp;gt;首次引入混合注意力&amp;lt;/font&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸MoE专家扩容4倍+共享专家&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸原生统一多模态预训练&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸默认开启深度Thinking&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸综合评测超GPT5.2/Claude4.5 开源性能标杆&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;151.25\&quot; width=\&quot;284\&quot; x=\&quot;792\&quot; y=\&quot;395\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-12\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; style=\&quot;endArrow=classic;html=1;rounded=0;strokeWidth=3;strokeColor=#808080;\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry height=\&quot;50\&quot; relative=\&quot;1\&quot; width=\&quot;50\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;50\&quot; y=\&quot;700\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;1560\&quot; y=\&quot;700\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-13\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; style=\&quot;endArrow=classic;html=1;rounded=0;strokeWidth=3;strokeColor=#808080;\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry height=\&quot;50\&quot; relative=\&quot;1\&quot; width=\&quot;50\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;50\&quot; y=\&quot;700\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;50\&quot; y=\&quot;80\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-15\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;2024年2月4日\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;171\&quot; y=\&quot;700\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-16\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;2024年9月19日\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;370\&quot; y=\&quot;700\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-17\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;2025年4月29日\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;656\&quot; y=\&quot;700\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-18\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;2026年2月16日\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;956\&quot; y=\&quot;700\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-20\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#990000;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;思考能力&amp;lt;/span&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;80\&quot; x=\&quot;380\&quot; y=\&quot;398.75\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-21\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#990000;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;首代MoE&amp;lt;/span&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;混合思考&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;55\&quot; width=\&quot;110\&quot; x=\&quot;530\&quot; y=\&quot;345\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-22\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#990000;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;原生多模态&amp;lt;/span&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;35\&quot; width=\&quot;105\&quot; x=\&quot;912.5\&quot; y=\&quot;235\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-23\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=#1ba1e2;strokeColor=#006EAF;fontSize=26;shadow=1;glass=0;fontStyle=1;fontColor=#ffffff;\&quot; value=\&quot;Qwen3.6&amp;amp;nbsp;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;72.5\&quot; width=\&quot;140\&quot; x=\&quot;1132\&quot; y=\&quot;207.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-24\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=#008a00;strokeColor=#005700;fontSize=26;shadow=1;glass=0;fontStyle=1;fontColor=#ffffff;\&quot; value=\&quot;Qwen3.7&amp;amp;nbsp;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;80\&quot; width=\&quot;150\&quot; x=\&quot;1340\&quot; y=\&quot;160\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-25\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; source=\&quot;vIzsuBNDGU4je8Ju_WXj-4\&quot; style=\&quot;html=1;endArrow=block;strokeWidth=4;fontSize=19;fontStyle=1;fontColor=#808080;strokeColor=#999999;entryX=-0.008;entryY=0.646;entryDx=0;entryDy=0;entryPerimeter=0;exitX=0.98;exitY=0.432;exitDx=0;exitDy=0;exitPerimeter=0;\&quot; target=\&quot;vIzsuBNDGU4je8Ju_WXj-23\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; x=\&quot;-0.1336\&quot; y=\&quot;33\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint as=\&quot;offset\&quot; /&gt;\n            &lt;mxPoint x=\&quot;950\&quot; y=\&quot;458\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;1094\&quot; y=\&quot;430\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-26\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; source=\&quot;vIzsuBNDGU4je8Ju_WXj-23\&quot; style=\&quot;html=1;endArrow=block;strokeWidth=4;fontSize=19;fontStyle=1;fontColor=#808080;strokeColor=#999999;entryX=0;entryY=0.5;entryDx=0;entryDy=0;exitX=1;exitY=0.5;exitDx=0;exitDy=0;\&quot; target=\&quot;vIzsuBNDGU4je8Ju_WXj-24\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; x=\&quot;-0.1336\&quot; y=\&quot;33\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint as=\&quot;offset\&quot; /&gt;\n            &lt;mxPoint x=\&quot;1220\&quot; y=\&quot;438\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;1364\&quot; y=\&quot;410\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-27\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;2026年3月30日\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;1130\&quot; y=\&quot;700\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-28\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;\&quot; value=\&quot;2026年5月19日\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;1310\&quot; y=\&quot;700\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-29\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=#f5f5f5;fillStyle=solid;labelBackgroundColor=none;fontColor=#333333;strokeColor=#666666;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;color: light-dark(rgb(0, 0, 0), rgb(237, 237, 237)); text-align: center; background-color: transparent;&amp;quot;&amp;gt;▸上下文扩容至百万&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸Agent编程能力&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent; color: light-dark(rgb(0, 0, 0), rgb(255, 255, 255));&amp;quot;&amp;gt;▸多模态增强&amp;lt;/span&amp;gt;&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸高性价比&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;105\&quot; width=\&quot;178\&quot; x=\&quot;1130\&quot; y=\&quot;285\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-30\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=#f5f5f5;fillStyle=solid;labelBackgroundColor=none;fontColor=#333333;strokeColor=#666666;\&quot; value=\&quot;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸长程Agent编程能力&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent; color: light-dark(rgb(0, 0, 0), rgb(255, 255, 255));&amp;quot;&amp;gt;▸多模态增强&amp;lt;/span&amp;gt;&amp;amp;nbsp;&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;color: rgb(0, 0, 0); font-family: Helvetica; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;▸高性价比&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;105\&quot; width=\&quot;178\&quot; x=\&quot;1340\&quot; y=\&quot;252.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-31\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=#6d8764;strokeColor=#3A5431;fontSize=26;shadow=1;glass=0;fontStyle=1;fontColor=#ffffff;\&quot; value=\&quot;Qwen1\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;110\&quot; x=\&quot;60\&quot; y=\&quot;640\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-32\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; source=\&quot;vIzsuBNDGU4je8Ju_WXj-31\&quot; style=\&quot;html=1;endArrow=block;strokeWidth=4;fontSize=19;fontStyle=1;fontColor=#808080;strokeColor=#999999;exitX=1;exitY=0.5;exitDx=0;exitDy=0;entryX=0.5;entryY=1;entryDx=0;entryDy=0;\&quot; target=\&quot;vIzsuBNDGU4je8Ju_WXj-33\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; x=\&quot;0.8985\&quot; y=\&quot;52\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint as=\&quot;offset\&quot; /&gt;\n            &lt;mxPoint x=\&quot;340\&quot; y=\&quot;630\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;450\&quot; y=\&quot;540\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-33\&quot; parent=\&quot;1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fillColor=#6d8764;strokeColor=#3A5431;fontSize=26;shadow=1;glass=0;fontStyle=1;fontColor=#ffffff;\&quot; value=\&quot;Qwen1.5\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;110\&quot; x=\&quot;180\&quot; y=\&quot;565\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-34\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; source=\&quot;vIzsuBNDGU4je8Ju_WXj-33\&quot; style=\&quot;html=1;endArrow=block;strokeWidth=4;fontSize=19;fontStyle=1;fontColor=#808080;strokeColor=#999999;exitX=0.5;exitY=0;exitDx=0;exitDy=0;entryX=0.5;entryY=1;entryDx=0;entryDy=0;\&quot; target=\&quot;vIzsuBNDGU4je8Ju_WXj-1\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; x=\&quot;0.8985\&quot; y=\&quot;52\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint as=\&quot;offset\&quot; /&gt;\n            &lt;mxPoint x=\&quot;240\&quot; y=\&quot;705\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;305\&quot; y=\&quot;650\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-35\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#990000;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;GQA&amp;lt;/span&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;50\&quot; x=\&quot;130\&quot; y=\&quot;570\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-38\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#6666FF;fillColor=none;fontSize=21;\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;font&amp;gt;&amp;lt;span style=&amp;quot;text-wrap-mode: nowrap; background-color: rgb(255, 255, 255);&amp;quot;&amp;gt;&amp;lt;b&amp;gt;（1）Dense框架成熟期&amp;lt;/b&amp;gt;&amp;lt;/span&amp;gt;&amp;lt;/font&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;140\&quot; x=\&quot;50\&quot; y=\&quot;365\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-39\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#6666FF;fillColor=none;fontSize=21;\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;font&amp;gt;&amp;lt;span style=&amp;quot;text-wrap-mode: nowrap; background-color: rgb(255, 255, 255);&amp;quot;&amp;gt;&amp;lt;b&amp;gt;（2）MoE架构探索期&amp;lt;/b&amp;gt;&amp;lt;/span&amp;gt;&amp;lt;/font&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;140\&quot; x=\&quot;410\&quot; y=\&quot;150\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-41\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#6666FF;fillColor=none;fontSize=21;\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;font&amp;gt;&amp;lt;span style=&amp;quot;text-wrap-mode: nowrap; background-color: rgb(255, 255, 255);&amp;quot;&amp;gt;&amp;lt;b&amp;gt;（3）混合注意力革命期&amp;lt;/b&amp;gt;&amp;lt;/span&amp;gt;&amp;lt;/font&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;140\&quot; x=\&quot;902.5\&quot; y=\&quot;100\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-43\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#6666FF;fillColor=none;fontSize=21;\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;font&amp;gt;&amp;lt;span style=&amp;quot;text-wrap-mode: nowrap; background-color: rgb(255, 255, 255);&amp;quot;&amp;gt;&amp;lt;b&amp;gt;（4）Agentic能力内化期&amp;lt;/b&amp;gt;&amp;lt;/span&amp;gt;&amp;lt;/font&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;140\&quot; x=\&quot;1250\&quot; y=\&quot;60\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-44\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=none;fillStyle=solid;labelBackgroundColor=none;fontColor=#663300;fontStyle=1\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent;&amp;quot;&amp;gt;命题：优先显存下支持更长上下文&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;295\&quot; x=\&quot;50\&quot; y=\&quot;398.75\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-45\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=none;fillStyle=solid;labelBackgroundColor=none;fontColor=#663300;fontStyle=1\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent;&amp;quot;&amp;gt;命题：扩大规模时控制计算成本&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;295\&quot; x=\&quot;370\&quot; y=\&quot;185\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-46\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=none;fillStyle=solid;labelBackgroundColor=none;fontColor=#663300;fontStyle=1\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent;&amp;quot;&amp;gt;命题：百万上下文内化&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent;&amp;quot;&amp;gt;计算复杂度线性化&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;205\&quot; x=\&quot;927.5\&quot; y=\&quot;137\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-47\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=none;fillStyle=solid;labelBackgroundColor=none;fontColor=#663300;fontStyle=1\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent;&amp;quot;&amp;gt;命题：响应指令→自主规划&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;Agent能力架构内化&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;245\&quot; x=\&quot;1272\&quot; y=\&quot;95\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-48\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=27;fillColor=none;fillStyle=solid;labelBackgroundColor=none;fontColor=#333333;fontStyle=1\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent;&amp;quot;&amp;gt;Qwen模型家族进化图&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;336.5\&quot; x=\&quot;873.5\&quot; y=\&quot;10\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-49\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#990000;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;MHA&amp;lt;/span&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;60\&quot; x=\&quot;60\&quot; y=\&quot;605\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-50\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontSize=19;fillColor=none;fillStyle=solid;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;div style=&amp;quot;text-align: center;&amp;quot;&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent; color: light-dark(rgb(0, 0, 0), rgb(255, 255, 255));&amp;quot;&amp;gt;显存降低4-8倍&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;140\&quot; x=\&quot;230\&quot; y=\&quot;610\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-51\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#990000;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;普及GQA&amp;lt;/span&amp;gt;&amp;lt;span style=&amp;quot;font-size: 19px; font-weight: 700; white-space: nowrap; text-align: center; background-color: transparent; color: light-dark(rgb(153, 0, 0), rgb(255, 181, 181));&amp;quot;&amp;gt;首次引入MoE&amp;lt;/span&amp;gt;&amp;lt;div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;上下文外推 32k→128&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;80\&quot; width=\&quot;135\&quot; x=\&quot;75\&quot; y=\&quot;480\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-52\&quot; edge=\&quot;1\&quot; parent=\&quot;1\&quot; source=\&quot;vIzsuBNDGU4je8Ju_WXj-51\&quot; style=\&quot;edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;exitX=0.5;exitY=1;exitDx=0;exitDy=0;\&quot; target=\&quot;vIzsuBNDGU4je8Ju_WXj-51\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-53\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#990000;labelBackgroundColor=none;\&quot; value=\&quot;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;Agent能力内化&amp;lt;/span&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;35\&quot; width=\&quot;105\&quot; x=\&quot;1137.5\&quot; y=\&quot;172.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-55\&quot; parent=\&quot;1\&quot; style=\&quot;text;whiteSpace=wrap;html=1;fontColor=#333333;labelBackgroundColor=none;fontStyle=0\&quot; value=\&quot;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;①Function Call和Tool Use从&amp;lt;font style=&amp;quot;color: rgb(51, 51, 255);&amp;quot;&amp;gt;后训练&amp;lt;/font&amp;gt;内化到预训练&amp;lt;/span&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;②Qwen3.6-Plus：Agentic Coding（自主规划/执行/调试代码）&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;font-family: Helvetica; font-size: 19px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: nowrap; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;&amp;quot;&amp;gt;③Qwen3.6-Max-Preview： Preserve Thinking多轮对话延续推理&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;83.75\&quot; width=\&quot;560\&quot; x=\&quot;1090\&quot; y=\&quot;396.25\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;vIzsuBNDGU4je8Ju_WXj-56\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;【2026-6-2】wqw\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;171\&quot; x=\&quot;1219\&quot; y=\&quot;620\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;i0PjKCb9f1WinCENEZCW-1\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;2023年4月11日\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;30\&quot; y=\&quot;700\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;i0PjKCb9f1WinCENEZCW-2\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;2023年8月3日开源\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;140\&quot; x=\&quot;100\&quot; y=\&quot;720\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;i0PjKCb9f1WinCENEZCW-4\&quot; parent=\&quot;1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=16;fontColor=#808080;fontStyle=1\&quot; value=\&quot;2024年6月7日\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;250\&quot; y=\&quot;720\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n      &lt;/root&gt;\n    &lt;/mxGraphModel&gt;\n  &lt;/diagram&gt;\n&lt;/mxfile&gt;\n&quot;}"></div>
...
| **官方博客** | [Qwen2: 开源大模型新标杆](https://qwenlm.github.io/zh/blog/qwen2/) | [Qwen2.5-LLM: 扩展大型语言模型的边界](https://qwenlm.github.io/zh/blog/qwen2.5-llm/) | [Qwen3: 思深，行速](https://qwenlm.github.io/zh/blog/qwen3/) | [Qwen3.5: Towards Native Multimodal Agents](https://qwenlm.github.io/zh/blog/qwen3.5/) |
| **技术报告** | [Qwen2 Technical Report (PDF)](https://github.com/QwenLM/Qwen2/blob/main/Qwen2_Technical_Report.pdf) | [Qwen2.5 Technical Report (PDF)](https://arxiv.org/pdf/2412.15115v2) | [Qwen3 Technical Report (PDF)](https://github.com/QwenLM/Qwen3/blob/main/Qwen3_Technical_Report.pdf) | [Qwen3.5 Technical Report (PDF)](https://github.com/QwenLM/Qwen3.5/blob/main/Qwen3.5_Technical_Report.pdf) |
| **模型版本** | Dense：0.5B/1.8B/4B/7B/14B/32B/72B； | ① Dense：0.5B/1.5B/3B/7B/14B/32B/72B；<br>② 专家模型：<br>Qwen2.5-Coder：1.5B/7B/32B，在 5.5T 代码数据上训练<br>Qwen2.5-Math：1.5B/7B/72B，支持 CoT / PoT / TIR 多种推理方式<br>③ API 模型：Qwen2.5-Turbo（快速）、Qwen2.5-Plus（强力） | Dense：0.6B/1.7B/4B/8B/14B/32B；<br>MoE：30B-A3B/235B-A22B； | MoE：35B-A3B/122B-A10B/397B-A17B；<br>Dense：0.8B/2B/4B/9B； |
...
| **旗舰**开源模型 |	| Qwen2.5-72B	| Qwen3-235B-A22B	| Qwen3.5-397B-A17B |
...
| **Thinking能力** | 无原生思考；需手动引导；数学准确率~45% | 基础思考能力；支持指令触发；数学准确率~65% | 思考/非思考双模融合<br>支持 `/think` 指令切换；基础推理步骤；数学准确率~61% | 默认深度思考；自动/思考/快速三模式；<br>API参数控制；数学准确率~89% |
| **多模态**能力	| 纯文本（VL/Audio 为独立模型）<br>需独立部署Qwen2-VL（外挂）| 纯文本<br>独立部署Qwen2.5-VL/Omni（外挂） | 纯文本基座; 独立部署Qwen3-VL（外挂）	| 原生多模态<br>文本+视觉早期融合<br>支持视频分析、GUI自动化 |
...
- Blog: [QwQ-32B: 领略强化学习之力](http://qwenlm.github.io/blog/qwq-32b)
- HF: [QwQ-32B](http://huggingface.co/Qwen/QwQ-32B)
...
<img width="1080" height="1096" alt="image" src="https://github.com/user-attachments/assets/d20ddf99-98bd-4866-af0e-eb80ab29d3c5" />
...
各个版本部署总结
- 参考：[Mac上部署对比](https://www.zhetao.com/content1638)
...
【2025-12-8】[Qwen3 中的 Thinking 与 Non-Thinking 模式融合和后训练理解](https://zhuanlan.zhihu.com/p/1939478652929708893)

各阶段作用：

| 阶段   | 名称                  | 核心目标                     | 是否提升推理能力       |
|--------|-----------------------|------------------------------|------------------------|
| Stage 1 | Long-CoT Cold Start  | 构建**基础推理模式**，强调**泛化性**而非性能 | ✅ 是（基础性）|
| Stage 2 | Reasoning RL         | 使用高挑战性任务强化**推理**能力       | ✅ 强化（关键阶段）|
| Stage 3 | Thinking Mode Fusion | **融合** thinking与non-thinking模式  | ❌ 基本不提升|
| Stage 4 | General RL            | 提升**多轮交互、工具调用、对齐**等代理能力 | ❌（非纯粹推理）|

(1) 误解：
- Stage 3 会提升模型推理能力。

事实上，核心目标是**模式融合**，让模型能够根据用户指令（如 /think 或 /no think）自由切换响应模式。

Stage 3 并不以提升推理性能为目标。原因：
- Thinking 数据来源于 Stage 2 模型自身生成：未引入新知识或推理路径，仅用于“固化”已有推理行为；确保生成数据的风格与 Stage 2 一致，避免引入新知识干扰已有推理能力。
- Non-thinking 数据为**常规 SFT 数据**：不包含推理链，主要用于训练快速、直接的回答能力。采用标准的监督微调（SFT）数据集，包含直接问答、摘要、翻译等无需显式推理的任务。

两种数据均未引入新的推理挑战或反馈信号，因此模型的底层推理能力基本保持稳定。

两种模式的数据通过统一的 prompt 模板结构进行混合训练

<img width="949" height="331" alt="image" src="https://github.com/user-attachments/assets/b5a864be-71e7-4393-b594-d3d4c84f17f5" />
...
【2026-2-14】官方介绍：[Qwen3.5：迈向原生多模态智能体](https://qwen.ai/blog?id=qwen3.5)
...
[Qwen3.5](https://github.com/QwenLM/Qwen3.5) 增强特性：
- 统一视觉语言基础：通过对多模态 Token **早期**融合训练，性能上与 Qwen3 跨代对齐，并在推理、代码生成、智能体和视觉理解等基准测试中**超越**了 Qwen3-VL系列模型。
- 高效混合架构：`门控增量网络`（Gated Delta Networks）与`稀疏混合专家`（sparse Mixture-of-Experts）相结合，高吞吐量推理的同时，将延迟和成本开销降至最低。
- 可扩展强化学习泛化能力：在包含百万智能体的环境中进行强化学习扩展，并逐步增加任务分布的复杂度，从而提升模型在真实世界中的稳健适应能力。
- 全球语言覆盖：支持的语言和方言扩展至 201 种，能够实现更具包容性的全球部署，并具备更精细的文化和区域理解能力。

下一代训练基础设施：多模态训练效率接近纯文本训练水平，同时异步强化学习框架可支持大规模智能体支架和环境编排。

Qwen3.5 模型同时支持**非思考**模式和**思考**模式。
- Qwen3.5-2B 默认以**非思考**模式运行
...
Qwen3.5 不再是传统“视觉编码器 + 文本解码器”**双塔**结构，而是采用 端到端**单塔**融合架构：
...
Qwen3.5 是 **混合注意力架构**（Hybrid Attention）：部分层用`线性注意力`（高效），部分层用`标准注意力`（强表达力）
...
Qwen 模型家族
- [modelscope](https://www.modelscope.cn/collections/Qwen/Qwen35)

<img width="800" height="100%" alt="image" src="https://github.com/user-attachments/assets/365453fd-ab82-4a30-befb-484824b82d8b" />


【2026-2-27】Qwen3.5系列
- 第一款模型 `Qwen3.5-Plus`
- 随后阿里云百炼平台上线 `Qwen3.5-Flash`，基于 Qwen3.5-35B-A3B 增强而来
...
|---|---|---|---|---|---|
| **Qwen3.5-397B-A17B** | 2026-02-16 | 总397B，激活17B | Sparse (MoE) | 旗舰多模态，原生视觉-语言，256K上下文（可扩1M），201种语言，百万级Agent强化学习 | Hugging Face: [Qwen3.5-397B-A17B](https://huggingface.co/Qwen/Qwen3.5-397B-A17B)<br>ModelScope: [Qwen3.5-397B-A17B](https://www.modelscope.cn/models/Qwen/Qwen3.5-397B-A17B) |
| **Qwen3.5-122B-A10B** | 2026-02-25 | 总122B，激活10B | Sparse (MoE) | 旗舰开源，对标前沿闭源模型，知识密集与视觉任务表现突出 | Hugging Face: [Qwen3.5-122B-A10B](https://huggingface.co/Qwen/Qwen3.5-122B-A10B)<br>ModelScope: [Qwen3.5-122B-A10B](https://www.modelscope.cn/models/Qwen/Qwen3.5-122B-A10B) |
| **Qwen3.5-35B-A3B** | 2026-02-25 | 总35B，激活3B | Sparse (MoE) | 小体积强性能，超越前代Qwen3-235B，24GB显存可运行 | Hugging Face: [Qwen3.5-35B-A3B](https://huggingface.co/Qwen/Qwen3.5-35B-A3B)<br>ModelScope: [Qwen3.5-35B-A3B](https://www.modelscope.cn/models/Qwen/Qwen3.5-35B-A3B) |
| **Qwen3.5-Flash** | 2026-02-25 | 对应35B-A3B | Sparse (MoE) | 生产级托管API，默认1M上下文，低延迟低成本（0.2元/百万Token） | 阿里云百炼API: [bailian](https://www.aliyun.com/product/bailian) |
| **Qwen3.5-0.8B** | 2026-03-02 | 0.8B | Dense | 超轻量，端侧/实时交互场景专用 | Hugging Face: [Qwen3.5-0.8B](https://huggingface.co/Qwen/Qwen3.5-0.8B)<br>ModelScope: [Qwen3.5-0.8B](https://www.modelscope.cn/models/Qwen/Qwen3.5-0.8B) |
| **Qwen3.5-2B** | 2026-03-02 | 2B | Dense | 极致轻量，推理极快，端侧/边缘设备首选 | Hugging Face: [Qwen3.5-2B](https://huggingface.co/Qwen/Qwen3.5-2B)<br>ModelScope: [Qwen3.5-2B](https://www.modelscope.cn/models/Qwen/Qwen3.5-2B) |
| **Qwen3.5-4B** | 2026-03-02 | 4B | Dense | 轻量级Agent基座，多模态能力强，资源与性能平衡 | Hugging Face: [Qwen3.5-4B](https://huggingface.co/Qwen/Qwen3.5-4B)<br>ModelScope: [Qwen3.5-4B](https://www.modelscope.cn/models/Qwen/Qwen3.5-4B) |
| **Qwen3.5-9B** | 2026-03-02 | 9B | Dense | 紧凑尺寸，越级性能，媲美GPT-OSS-120B，高性价比服务器部署 | Hugging Face: [Qwen3.5-9B](https://huggingface.co/Qwen/Qwen3.5-9B)<br>ModelScope: [Qwen3.5-9B](https://www.modelscope.cn/models/Qwen/Qwen3.5-9B) |
| **Qwen3.5-27B** | 2026-02-25 | 27B | Dense | 全系列唯一稠密架构，编码与指令遵循最强（LiveCodeBench 80.7，IFEval 95.0），复杂Agent场景出色 | Hugging Face: [Qwen3.5-27B](https://huggingface.co/Qwen/Qwen3.5-27B)<br>ModelScope: [Qwen3.5-27B](https://www.modelscope.cn/models/Qwen/Qwen3.5-27B) |
...
- 8g显卡+32g内存，unsloth q4量化，35B-A3B比27B推理速度快15倍
  - 【2026-2-26】参考 [deephub](https://www.zhihu.com/question/2009949864205710678/answer/2010011967776122872)


#### 体验

[Qwen Chat](https://chat.qwen.ai/?spm=a2ty_o06.30285417.0.0.72bcc9216Zogj5) 上用 Qwen3.5。提供`自动`（auto）、`思考`（thinking）与`快速`（fast）三种模式供用户选择。
...
资讯
- [千问3.5发布，四成参数超越万亿模型，大模型的竞赛逻辑变了](https://news.qq.com/rain/a/20260216A06VD200)
...
详见：[知乎](https://www.zhihu.com/question/2009949864205710678)

#### 代码解析

【2026-2-13】知乎 [李先生](https://zhuanlan.zhihu.com/p/2005048984805336584)

Qwen3.5 在transformer 仓库中提交PR，大致了解Qwen3.5 信息
- [PR代码链接](https://github.com/huggingface/transformers/pull/43830)
...
【2026-3-4】[Qwen3.5 0.8B/2B/4B/9B 小模型本地部署指南，微调教程](https://zhuanlan.zhihu.com/p/2012668704182260051)
...
| 输入处理     | 仅 `input_ids` → `embeddings`           | `input_ids` + `<image>` 占位符 → 动态替换为视觉 token embeddings         |
...
- [使用 LlamaFactory 微调最新一代 Qwen3.5 模型辨别人形机器人型号](https://blog.llamafactory.net/posts/qwen3_5_finetuning/)

多轮对话数据集，链接：[mllm_robot.zip](https://drive.google.com/file/d/1Bapd-3B_x8OW9mFOKiHTjG2GchKUBdUg/view?usp=sharing)
...
官方代码 [qwen3_5](https://github.com/modelscope/ms-swift/tree/main/examples/models/qwen3_5)
...
- 官方：[Qwen3.5 微调指南](https://unsloth.ai/docs/zh/mo-xing/qwen3.5/fine-tune)
...
- [Qwen3.5-0.8B](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Qwen3_5_(0_8B)_Vision.ipynb)
- [Qwen3.5-2B](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Qwen3_5_(2B)_Vision.ipynb)
- [Qwen3.5-4B](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Qwen3_5_(4B)_Vision.ipynb)
...
Qwen3.5 是原生多模态模型, Unsloth 同样支持**视觉微调**，用图文对数据来训练模型的视觉理解能力：
...
【2026-3-30】阿里Qwen在OpenRouter悄然上线 [Qwen 3.6 Plus Preview](https://openrouter.ai/qwen/qwen3.6-plus-preview:free)
...
【2026-4-2】[Qwen3.6-Plus：编码智能体能力全面跃升](https://mp.weixin.qq.com/s/pT8XdlfPe9txei3iMV_WmQ)
- 显著提升模型的**智能体编程能力**。在前端页面生成、代码修复、终端自动化等场景中，Qwen3.6-Plus 表现出更稳定的任务执行能力。
- 同时，模型默认支持 **100 万**上下文窗口
- 多模态感知与推理能力也同步优化。
...
【2026-4-22】[Qwen3.6-27B正式开源](https://mp.weixin.qq.com/s/NAoMdaQecGthMNxD2UDwoQ)

将智能密度压榨到极致，Qwen3.6-27B让本‍地部署的模型，也能完成以往大尺寸或是MoE模型才能实现的智能体编程任务，有望成为OpenClaw等类龙虾应用或者Hermes Agent最可靠的本地大脑。

Qwen3.6-27B的开源权重已在Hugging Face和ModelScope上提供，支持本地部署；企业和开发者也可通过阿里云百炼API调用；用户也可在Qwen Studio上即时体验。
- 魔搭社区：[Qwen3.6-27B](https://modelscope.cn/models/Qwen/Qwen3.6-27B)
- Hugging Face：[Qwen3.6-27B](https://huggingface.co/Qwen/Qwen3.6-27B?spm=a2ty_o06.30285417.0.0.7550c921oNQ1lc&file=Qwen3.6-27B)
...
Qwen3.8 发布，很快开源权重！
- 拥有 2.4T 海量参数，正在持续进化。
- 目前最强大的模型之一，可与领先的前沿 AI 模型媲美，仅次于 Fable 5。

【2026-8-23】Qwen3.8-27B 跻身代码模型前十，仅次于 GLM-5.3-MAX
...
开源模型：30b 模型占70G，[huggingface地址](https://huggingface.co/Qwen/Qwen3-Omni-30B-A3B-Instruct)
- Qwen3-Omni-30B-A3B-`Instruct`：Qwen3-Omni-30B-A3B 的**指令**模型，包含思考者和说话者组件，支持音频、视频和文本输入，输出音频和文本。更多信息请阅读 Qwen3-Omni 技术报告。
- Qwen3-Omni-30B-A3B-`Thinking`：Qwen3-Omni-30B-A3B 的**思考**模型，包含思考者组件，具备链式思维推理能力，支持音频、视频和文本输入，输出文本。更多信息请阅读 Qwen3-Omni 技术报告。
- Qwen3-Omni-30B-A3B-`Captioner`：从 Qwen3-Omni-30B-A3B-Instruct 微调而来的下游音频细粒度**字幕**模型，为任意音频输入生成详细且低幻觉的字幕。包含思考者组件，支持音频输入和文本输出。更多信息可以参考该模型的 cookbook。

注：
- moe 稀疏模型与同型号的dense 稠密模型相比，训练、推理时占用的显存相同，但速度不同，moe模型更快，如30B-A3B模型，推理速度接近 3B 全参模型（比30b稠密模型快 5-10 倍）

详见 [阿里开源Qwen3-Omni-30B-A3B三剑客——Instruct、Thinking 和 Captioner - 指南](https://www.cnblogs.com/clnchanpin/p/19203825)
...
【2026-3-30】[视听全才，言出码随！全模态Qwen3.5-Omni上线](https://zhuanlan.zhihu.com/p/2022053482077726160)
- huggingface [demo](https://huggingface.co/spaces/Qwen/Qwen3.5-Omni-Online-Demo)
- modelscope [demo](https://modelscope.cn/studios/Qwen/Qwen3.5-Omni-Online-Demo)
- 【2026-4-21】技术报告 [Qwen3.5-Omni Technical Report](https://arxiv.org/pdf/2604.15804)
...
![](https://pic1.zhimg.com/v2-333fc6c0253ec236defd6d840a9eb344_1440w.jpg)
...
| ---- | ---- | ---- |
| 主干框架 | MoE | Hybrid-MoE |
| 支持序列 | 32k | 256k<br>音频：10个小时<br>音视频 (FPS=1)：400秒 |
| Caption能力 | 音频 | 音视频 |
| 智能语义打断 | 无 | 支持 |
...
| 语音识别 | • 11种多语言：中文、英语、德语、法语、意大利语、泰语、韩语、日语、俄语、西班牙语、葡萄牙语<br>• 8种方言：四川话、上海话、粤语、闽南语、陕西话、南京话、天津话、北京话 | • 74种多语言：南非语、阿拉伯语、阿斯图里亚斯语、阿塞拜疆语、巴斯克语、维吾尔语、白俄罗斯语、孟加拉语、波斯尼亚语、保加利亚语、粤语、加泰罗尼亚语、宿务语、中文、克罗地亚语、捷克语、丹麦语、荷兰语、英语、世界语、爱沙尼亚语、菲律宾语、芬兰语、法语、加利西亚语、格鲁吉亚语、德语、希腊语、希伯来语、印地语、匈牙利语、冰岛语、印尼语、国际语、意大利语、日语等<br>• 39种方言：东北话、贵州话、粤语、河南话、香港粤语、上海话、陕西话、天津话、台湾话、云南话、安徽话、福建话、甘肃话、广东话、湖北话、湖南话、江西话、山东话、山西话、四川话、广西话、海南话、重庆话、长沙话、杭州话、合肥话、银川话、郑州话、沈阳话、温州话、武汉话、昆明话、太原话、南昌话、济南话、兰州话、南京话、客家话、闽南语 |
| 语音合成 |  | • 29种多语言：中文、英语、德语、意大利语、葡萄牙语、西班牙语、日语、韩语、法语、俄语、泰语、印度尼西亚语、阿拉伯语、越南语、土耳其语、芬兰语、波兰语、印地语、荷兰语、捷克语、乌尔都语、他加禄语、瑞典语、丹麦语、希伯来语、冰岛语、马来语、挪威语、波斯语<br>• 7种方言：四川话、北京话、天津话、南京话、陕西话、上海话、粤语 |
