...
3D 点云计算及物体分割, 详见: [三维重建-SpatialLM](graphic#SpatialLM)


### 图像描述


【2025-11-16】[ComfyUI - 使用 Joy Caption 模型 描述和打标 图像数据集 (Image Caption)](https://blog.csdn.net/caroline_wendy/article/details/141605718)
