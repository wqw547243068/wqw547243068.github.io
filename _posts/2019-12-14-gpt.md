...
tags: GPT gpt 文本生成 对抗 攻击 OpenAI AIGC ChatGPT 具身智能 乔姆斯基 模仿学习 nanaogpt baby
...
【2023-5-30】[GPT 是如何工作的：200 行 Python 代码实现一个极简 GPT](https://mp.weixin.qq.com/s/ll6AZTUSBt8bvgjcwKcY3A)
- ak-47的[twitter](https://twitter.com/karpathy/status/1645115622517542913)
- [Colab笔记](https://colab.research.google.com/drive/1SiF0KZJp75rUeetKOWqpsA8clmHP6jMg?usp=sharing#scrollTo=yseminfTx52k)
...
- GPT 是一个有限状态马尔可夫链（FSMC）。将用 token sequence 111101111011110 作为输入对这个极简 GPT 训练 50 次， 得到的状态转移概率符合我们的预期。
