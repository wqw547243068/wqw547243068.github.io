...
【2025-12-2】[在线监督微调（OSFT）](https://www.emergentmind.com/topics/online-supervised-finetuning-osft)

OSFT 是一种**无奖励**的迭代**自监督**方法，通过生成并监督其自身的训练数据来微调 LLMs。采用解耦采样和训练温度来增强潜在推理能力，在数学基准测试中取得了具有竞争力的结果。该方法展示了高训练效率和可扩展性，为强化学习策略提供了一种更简单的替代方案。
