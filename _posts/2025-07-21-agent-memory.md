...
categories: 大模型
tags: LLM agent 智能体 记忆 强化学习 graphrag rag 知识图谱 遗忘 评测 自进化
excerpt: 智能体记忆设计专题
mathjax: true
...
模型到底是「怎么记住东西的」？
- 大模型给出的答案，不是Transformer，不是参数量，而是一个更原始、更根本的概念：`联想记忆`（Associative Memory）。
...
详见站内专题：[大模型发展方向：嵌套学习](llm_direction)
...
【2026-8-4】国外高校联合综述，90 页论文列举了 150 多种智能体内存架构，构建能够**自我进化**的长期预测智能体。
- 论文 [A Survey of Agent Memory in the Second Half: TowardsSelf-Evolving and Long-Horizon Agents](https://arxiv.org/abs/2602.06052)

AI研究正迎来范式转变：研究重心从优先开展模型创新、刷取评测基准分数，转向**重视问题定义**与严谨的**真实场景评估**。

行业迈入发展 “下半场” 之后，核心难题转变为Agent在长周期、动态变化、受用户影响的环境中产出实际价值，典型场景包含智能体自动编程、深度调研、计算机操控。

这类场景下，基于大语言模型的智能体会遭遇超出固定上下文窗口的信息膨胀问题；在长时间交互过程里，必须不断积攒、管控并有选择地复用海量信息。

仅 2025 年就已有数百篇相关论文问世，记忆机制就此成为补齐智能体实用短板的关键方案。

记忆不再只是被动的数据存储空间，逐步成为智能体实现**自我迭代进化**的底层载体：
- 短期记忆负责筛选智能体运行过程中感知、挑选、提炼的经验；
- 长期记忆则沉淀、整合这些经验，转化成可复用的知识与技能，搭建起闭环，让智能体依托自身经历迭代升级、实现持续学习。

现在的LLM agent最大的问题不是推理弱, 而是记性差。
- 跑一个长任务,聊了八十轮,前面说过的偏好、踩过的坑、犯过的错,下一轮可能就忘了。

论文把agent的记忆拆成三个维度
- 存在哪里(内部权重还是外部数据库)
- 干什么用(感觉、工作、情景、语义、程序记忆,基本照搬人类认知心理学那套)
- 为谁服务(记用户的,还是记agent自己踩过的坑)。

（1）大部分benchmark测的都是"记住某个事实",比如上次说喜欢猫,agent这次还记不记得。

但真实世界里更难的是"记忆要不要更新",用户偏好变了、信息过时了、两条记忆互相矛盾了,这些benchmark基本没测。

ChatGPT的记忆功能都上线一段时间了,学术界对"如何优雅地忘记"这件事研究得还是很少,大家都在教agent怎么记,没怎么教它怎么忘。

（2）多agent记忆冲突。几个agent同时干活,各自更新记忆,写进同一个池子里,难免打架。
- 论文举例,一个系统里"讲话的"agent因为读到了"推理的"agent还没更新完的旧状态,给用户答错了话。
- 这种问题人类团队协作里也天天发生,只是放在agent系统里更赤裸,因为没有人情世故这层。

记忆这件事正在从"prompt里塞点历史对话"变成真正的系统工程问题,存储、检索、遗忘、多agent协同、隐私安全,至于六个开放挑战里提到的"终身个性化",其实就是agent到底该怎么在不侵犯隐私的前提下,越用越懂你。

这目标听着简单,做起来不比训一个更大的模型容易。

综述从三大维度搭建基础智能体记忆体系的统一框架：
- `记忆载体`：模型内部参数状态、基于检索增强的外部存储库
- `认知机制`：感知记忆、工作记忆、情景记忆、语义记忆、程序记忆
- `记忆主体`：面向用户的个性化记忆、面向智能体自身的经验记忆

随后本文分析单智能体、多智能体架构之下记忆的运行方式，重点解读记忆操作对应的学习策略；

阐明记忆管理本身已经进化为可训练、能够自主演化的能力，涵盖强化学习驱动的上下文筛选、决策阶段的经验整合；

同时当下已经兴起一套显性、可迁移、可共享的智能体技能生态，依托智能体调度框架、上下文工程、标准化工具调用协议落地实现。

结果：
- 一个 3D 分类系统表明，基于行为的记忆机制以及自我进化的结构能够将长期记忆的保留能力提升 50%。

令人惊讶的是，记忆已经不再只是简单的数据库查询了，还会训练模型来执行工具操作、更新参数权重，并将各种情节片段整合为技能。

大多数内存调查显示，数据库检索操作是静态的。这个模型涵盖了整个自演化代理操作系统。
...
<!-- draw.io diagram -->
<div class="mxgraph" style="max-width:100%;border:1px solid transparent;" data-mxgraph="{&quot;highlight&quot;:&quot;#0000ff&quot;,&quot;nav&quot;:true,&quot;resize&quot;:true,&quot;dark-mode&quot;:&quot;auto&quot;,&quot;toolbar&quot;:&quot;zoom layers tags lightbox&quot;,&quot;edit&quot;:&quot;_blank&quot;,&quot;xml&quot;:&quot;&lt;mxfile host=\&quot;app.diagrams.net\&quot;&gt;\n  &lt;diagram name=\&quot;第 1 页\&quot; id=\&quot;5qJ6CVLS-rSEMToXttzO\&quot;&gt;\n    &lt;mxGraphModel dx=\&quot;955\&quot; dy=\&quot;694\&quot; grid=\&quot;1\&quot; gridSize=\&quot;10\&quot; guides=\&quot;1\&quot; tooltips=\&quot;1\&quot; connect=\&quot;1\&quot; arrows=\&quot;1\&quot; fold=\&quot;1\&quot; page=\&quot;1\&quot; pageScale=\&quot;1\&quot; pageWidth=\&quot;827\&quot; pageHeight=\&quot;1169\&quot; math=\&quot;0\&quot; shadow=\&quot;0\&quot;&gt;\n      &lt;root&gt;\n        &lt;mxCell id=\&quot;_4N4RH5fQUqG_UO8TCS8-0\&quot; /&gt;\n        &lt;mxCell id=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-0\&quot; /&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=0;whiteSpace=wrap;html=1;dashed=1;fillColor=#f5f5f5;fontColor=#333333;strokeColor=#666666;\&quot; value=\&quot;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;185\&quot; width=\&quot;199.97\&quot; x=\&quot;130.03\&quot; y=\&quot;280\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=0;whiteSpace=wrap;html=1;dashed=1;fillColor=#f5f5f5;fontColor=#333333;strokeColor=#666666;\&quot; value=\&quot;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;100\&quot; width=\&quot;182.18\&quot; x=\&quot;137.82\&quot; y=\&quot;289\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;bPDF5BSF2NcRuIK_Pjmh-12\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;Context\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;50\&quot; x=\&quot;70\&quot; y=\&quot;300\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;bPDF5BSF2NcRuIK_Pjmh-25\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=20;fontStyle=0\&quot; value=\&quot;Anthuropic 五层记忆系统\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;242.5\&quot; x=\&quot;550\&quot; y=\&quot;100\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;bPDF5BSF2NcRuIK_Pjmh-30\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontColor=#666666;\&quot; value=\&quot;【2026-9-23】wqw\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;134.93\&quot; x=\&quot;300\&quot; y=\&quot;510\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-0\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=15;fillColor=#1ba1e2;strokeColor=none;fontColor=#ffffff;shadow=1;\&quot; value=\&quot;工作记忆&amp;lt;div&amp;gt;Work Memory&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;60\&quot; width=\&quot;120\&quot; x=\&quot;400\&quot; y=\&quot;342.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-24\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;lWmpqvo6ol3AyN-woul0-1\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;entryX=0;entryY=0.5;entryDx=0;entryDy=0;strokeWidth=3;strokeColor=#666666;exitX=1;exitY=0.5;exitDx=0;exitDy=0;\&quot; target=\&quot;siGAxDW4bsz16XlYscF7-0\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-2\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=15;fillColor=#008a00;strokeColor=none;fontColor=#ffffff;shadow=1;align=left;\&quot; value=\&quot;在吗，货还没到\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;141.09\&quot; x=\&quot;158.91\&quot; y=\&quot;295\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-3\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=15;fillColor=#008a00;strokeColor=none;fontColor=#ffffff;shadow=1;align=left;\&quot; value=\&quot;哪里哪里\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;91.09\&quot; x=\&quot;158.91\&quot; y=\&quot;395\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-4\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=15;fillColor=#008a00;strokeColor=none;fontColor=#ffffff;shadow=1;align=left;\&quot; value=\&quot;该点那个按钮\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;134.93\&quot; x=\&quot;158.91\&quot; y=\&quot;345\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-6\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;当前问题\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;70.07\&quot; x=\&quot;59.96000000000001\&quot; y=\&quot;415\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-21\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;当前轮\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;75\&quot; x=\&quot;508.04\&quot; y=\&quot;240\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;siGAxDW4bsz16XlYscF7-29\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=18;fillColor=#d80073;strokeColor=none;fontColor=#ffffff;shadow=1;\&quot; value=\&quot;遗忘引擎&amp;lt;div&amp;gt;Forgetting Engine&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;60\&quot; width=\&quot;160\&quot; x=\&quot;850.55\&quot; y=\&quot;195\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-2\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;Task&amp;lt;div&amp;gt;&amp;lt;span style=&amp;quot;background-color: transparent; color: light-dark(rgb(102, 102, 102), rgb(149, 149, 149));&amp;quot;&amp;gt;Context&amp;lt;/span&amp;gt;&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;50\&quot; x=\&quot;340\&quot; y=\&quot;324\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-3\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=15;fillColor=#008a00;strokeColor=none;fontColor=#ffffff;shadow=1;align=left;\&quot; value=\&quot;Agent输出\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;40\&quot; width=\&quot;91.09\&quot; x=\&quot;626\&quot; y=\&quot;255\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-4\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=15;fillColor=#1ba1e2;strokeColor=none;fontColor=#ffffff;shadow=1;\&quot; value=\&quot;情景记忆Episodic&amp;lt;span style=&amp;quot;background-color: transparent; color: light-dark(rgb(255, 255, 255), rgb(18, 18, 18));&amp;quot;&amp;gt;&amp;amp;nbsp;Memory&amp;lt;/span&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;60\&quot; width=\&quot;141.09\&quot; x=\&quot;630\&quot; y=\&quot;342.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-5\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=15;fillColor=#1ba1e2;strokeColor=none;fontColor=#ffffff;shadow=1;\&quot; value=\&quot;语义记忆&amp;lt;div&amp;gt;Semantic Memory&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;60\&quot; width=\&quot;141.09\&quot; x=\&quot;860\&quot; y=\&quot;342.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-6\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;rounded=1;whiteSpace=wrap;html=1;fontStyle=1;fontSize=15;fillColor=#1ba1e2;strokeColor=none;fontColor=#ffffff;shadow=1;\&quot; value=\&quot;程序记忆Procedural&amp;lt;span style=&amp;quot;background-color: transparent; color: light-dark(rgb(255, 255, 255), rgb(18, 18, 18));&amp;quot;&amp;gt;&amp;amp;nbsp;Memory&amp;lt;/span&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;60\&quot; width=\&quot;141.09\&quot; x=\&quot;1025\&quot; y=\&quot;415\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-7\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;siGAxDW4bsz16XlYscF7-0\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;entryX=0;entryY=0.5;entryDx=0;entryDy=0;strokeWidth=3;strokeColor=#666666;exitX=0.5;exitY=0;exitDx=0;exitDy=0;edgeStyle=orthogonalEdgeStyle;\&quot; target=\&quot;lWmpqvo6ol3AyN-woul0-3\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;610\&quot; y=\&quot;360\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;713\&quot; y=\&quot;360\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-8\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;siGAxDW4bsz16XlYscF7-0\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;entryX=0;entryY=0.5;entryDx=0;entryDy=0;strokeWidth=3;strokeColor=#666666;exitX=1;exitY=0.5;exitDx=0;exitDy=0;startArrow=classic;startFill=1;\&quot; target=\&quot;lWmpqvo6ol3AyN-woul0-4\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;600\&quot; y=\&quot;350\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;703\&quot; y=\&quot;350\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-9\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;lWmpqvo6ol3AyN-woul0-4\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;entryX=0;entryY=0.5;entryDx=0;entryDy=0;strokeWidth=3;strokeColor=#666666;exitX=1;exitY=0.5;exitDx=0;exitDy=0;\&quot; target=\&quot;lWmpqvo6ol3AyN-woul0-5\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;820\&quot; y=\&quot;350\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;923\&quot; y=\&quot;350\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-10\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;lWmpqvo6ol3AyN-woul0-5\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;strokeWidth=3;strokeColor=#666666;exitX=1;exitY=0.5;exitDx=0;exitDy=0;edgeStyle=orthogonalEdgeStyle;\&quot; target=\&quot;lWmpqvo6ol3AyN-woul0-6\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;1070\&quot; y=\&quot;380\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;1173\&quot; y=\&quot;380\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-12\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;siGAxDW4bsz16XlYscF7-29\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;entryX=0.5;entryY=0;entryDx=0;entryDy=0;strokeWidth=3;strokeColor=#666666;dashed=1;exitX=0.5;exitY=1;exitDx=0;exitDy=0;dashPattern=1 1;\&quot; target=\&quot;lWmpqvo6ol3AyN-woul0-5\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;1020\&quot; y=\&quot;270\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;1019\&quot; y=\&quot;290\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-14\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;siGAxDW4bsz16XlYscF7-29\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;entryX=0.5;entryY=0;entryDx=0;entryDy=0;strokeWidth=3;strokeColor=#666666;dashed=1;exitX=0.5;exitY=1;exitDx=0;exitDy=0;dashPattern=1 1;\&quot; target=\&quot;lWmpqvo6ol3AyN-woul0-4\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;930\&quot; y=\&quot;290\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;930\&quot; y=\&quot;378\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-15\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;裁剪旧记忆\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;91.09\&quot; x=\&quot;756.95\&quot; y=\&quot;270\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-16\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;解决冲突\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;75\&quot; x=\&quot;950\&quot; y=\&quot;284\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-17\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;蒸馏事实\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;75\&quot; x=\&quot;778\&quot; y=\&quot;342.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-18\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;编码方法\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;75\&quot; x=\&quot;1100\&quot; y=\&quot;385\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-19\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;lWmpqvo6ol3AyN-woul0-6\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;entryX=0.425;entryY=1.008;entryDx=0;entryDy=0;strokeWidth=3;strokeColor=#666666;exitX=0.5;exitY=1;exitDx=0;exitDy=0;entryPerimeter=0;edgeStyle=orthogonalEdgeStyle;dashed=1;dashPattern=1 1;\&quot; target=\&quot;siGAxDW4bsz16XlYscF7-0\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;mxPoint x=\&quot;1070\&quot; y=\&quot;480\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;1179\&quot; y=\&quot;547\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-20\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;加载Skill\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;75\&quot; x=\&quot;907.5\&quot; y=\&quot;461\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-21\&quot; edge=\&quot;1\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; source=\&quot;lWmpqvo6ol3AyN-woul0-5\&quot; style=\&quot;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;fontFamily=Helvetica;fontSize=12;fontColor=#666666;entryX=0.75;entryY=1;entryDx=0;entryDy=0;strokeWidth=3;strokeColor=#666666;edgeStyle=orthogonalEdgeStyle;exitX=0.5;exitY=1;exitDx=0;exitDy=0;dashed=1;dashPattern=1 1;\&quot; target=\&quot;siGAxDW4bsz16XlYscF7-0\&quot; value=\&quot;\&quot;&gt;\n          &lt;mxGeometry relative=\&quot;1\&quot; as=\&quot;geometry\&quot;&gt;\n            &lt;Array as=\&quot;points\&quot;&gt;\n              &lt;mxPoint x=\&quot;930.5\&quot; y=\&quot;450\&quot; /&gt;\n              &lt;mxPoint x=\&quot;490\&quot; y=\&quot;450\&quot; /&gt;\n            &lt;/Array&gt;\n            &lt;mxPoint x=\&quot;1050\&quot; y=\&quot;470\&quot; as=\&quot;sourcePoint\&quot; /&gt;\n            &lt;mxPoint x=\&quot;980\&quot; y=\&quot;470\&quot; as=\&quot;targetPoint\&quot; /&gt;\n          &lt;/mxGeometry&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-22\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;检索事实\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;75\&quot; x=\&quot;765\&quot; y=\&quot;415\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-23\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;溢出\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;35\&quot; x=\&quot;574\&quot; y=\&quot;372.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-24\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#666666;\&quot; value=\&quot;召回事件\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;70.07\&quot; x=\&quot;524.93\&quot; y=\&quot;342.5\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-25\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#3333FF;\&quot; value=\&quot;交互日志&amp;lt;div&amp;gt;（发生了啥）&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;99.45\&quot; x=\&quot;925.55\&quot; y=\&quot;410\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-26\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#3333FF;\&quot; value=\&quot;技能复用&amp;lt;br&amp;gt;&amp;lt;div&amp;gt;（如何操作）&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;99.45\&quot; x=\&quot;1087.77\&quot; y=\&quot;490\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-27\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#3333FF;\&quot; value=\&quot;上下文窗口&amp;lt;br&amp;gt;&amp;lt;div&amp;gt;（session刷新）&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;640\&quot; y=\&quot;405\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n        &lt;mxCell id=\&quot;lWmpqvo6ol3AyN-woul0-28\&quot; parent=\&quot;_4N4RH5fQUqG_UO8TCS8-1\&quot; style=\&quot;text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;fontSize=15;fontStyle=1;fontColor=#3333FF;\&quot; value=\&quot;知识图谱&amp;lt;div&amp;gt;（什么是对的）&amp;lt;/div&amp;gt;\&quot; vertex=\&quot;1\&quot;&gt;\n          &lt;mxGeometry height=\&quot;30\&quot; width=\&quot;120\&quot; x=\&quot;990\&quot; y=\&quot;315\&quot; as=\&quot;geometry\&quot; /&gt;\n        &lt;/mxCell&gt;\n      &lt;/root&gt;\n    &lt;/mxGraphModel&gt;\n  &lt;/diagram&gt;\n&lt;/mxfile&gt;\n&quot;}"></div>
...
因此，亟需一种能高效管理**短期工具记忆**的框架，平衡工具调用灵活性与上下文窗口限制。
...
- [Exploring Agentic Memory beyond Reasoning and Tool-Use](https://macaron.im/mindlab/research/exploring-agentic-memory-beyond-reasoning-and-tool-use)
- 原文网页中包含 demo
...
分析
- 模型不够好？
- 上海交大10月份Context Engineering 2.0论文，问题不在模型本身，而是**记忆管理架构**。
...
- 上海交大给了**工程**方案：分层设计、提取关键信息、主动预测用户
...
- 2) pip安装：使用 `pip install m_flow` 命令，并配置LLM API密钥。

该方案在多项Benchmark测试中表现优异。

### 【2026-6-13】腾讯：T-Mem 会推演

【2026-6-13】腾讯团队开源发布会"预演"的记忆系统「T-Mem」
当前四代长期记忆架构：
- Flat RAG、图结构记忆（GraphRAG、Zep、HyperMem）
- agentic 层级记忆（Mem0、A-Mem、MemoryBank）
- 操作系统式记忆内核（MemGPT、MemOS、MIRIX）
虽然结构各异，但检索配方却完全相同：
- 把查询和存储内容投进同一个相似度空间（BM25 或稠密向量），取 top-K。
这决定了一件事：记忆"可达性"被相似度封顶。

论文：T-Mem: Memory That Anticipates, Not Archives，https://arxiv.org/abs/2606.15405
开源项目：T-M，http://github.com/Sherlockwz/T-M


### 【2026-9-23】Anthropic

【2026-9-23】[五层记忆系统](https://x.com/AnnatarXBT/status/2101925393322091005)

Anthropic 发布 13 页的 PDF 文档，阐述Agent五层记忆机制——token成本降低 90%，具备遗忘能力，并真正学习新知识
- 很少有人搭建遗忘引擎。 判断另外四层记忆的信息是否还值得信任。
- https://drive.google.com/file/d/1DslNwq7amjaBZC8mDtDspvTu5VEJwUfC/view

五层记忆架构：
1. 工作记忆（Working memory）：当下所见信息。对应上下文窗口；空间占满后，旧上下文会被丢弃。 绝大多数智能体都停留在这一层，无法更进一步。
2. 情景记忆（Episodic memory）：过往发生的事件。带时间戳的完整交互日志。 周二凌晨3点因为一个拼写错误导致部署失败这件事，会被永久记住。 你只需要解释一次。
3. 语义记忆（Semantic memory）：客观事实。知识图谱里的事实、实体与关系。 “该用户偏好TypeScript语言”这类信息，会话结束后依然保留。
4. 程序记忆（Procedural memory）：做事方法。尝试过三种方案，其中一种可行；这个可行方案就成为可复用技能。 下一次运行直接从该方案起步。
5. 遗忘机制（Forgetting）：需要清理的内容。什么都记住的智能体会不断累积矛盾信息。 比如你搬了城市，它还一直给你推荐旧住址附近的餐厅。

相关数据：
- Mem0：单次查询token用量从26000降至1800， 延迟降低91%。 
- Snowflake：增加一层本体论，准确率提升20%，工具调用次数减少39%。
