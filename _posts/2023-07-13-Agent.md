...
【2023-8-8】LLM 评估沙盒 AgentSims ，开源
...
- 两个开放基准：**多模态图像**和**对话环境** AgentClinic-NEJM 和**纯对话**环境 AgentClinic-MedQA。
- AgentClinic-MedQA 中的代理以美国医学执照考试~（USMLE） 的案例为基础，而 AgentClinic-NEJM 的代理以多模式新英格兰医学杂志 （NEJM） 的案例挑战为基础。

在患者和医生代理中嵌入**认知和隐性偏见**，以模拟有偏见的代理之间的真实互动。
