...
1. 开发API（没有什么特别的，跟普通的API一样）
1. 写API文档（OpenAPI格式，就是Swagger生成的API文档）
1. 编写manifest插件配置文件

插件开发指南
- [官方指南](https://platform.openai.com/docs/plugins/introduction), [plugins-quickstart](https://github.com/openai/plugins-quickstart/tree/main), 以待办事项列表为例，5min开发一个插件
