...
【2026-3-18】node.js, npm 安装

Ubuntu 使用 APT 安装 Node.js 和 npm
...
# 以上方法有问题，旧版Ubuntu的nodejs版本低（<20），install新包时执行出错
# 解决方法：从官方源下载指定版本node.js安装
...
- [TypeScript](https://www.typescriptlang.org/) 是 JavaScript 的`超集`，扩展了 JavaScript 的语法，因此现有的 JavaScript 代码可与 TypeScript 一起工作无需任何修改
- TypeScript 通过**类型注解**提供**编译时**的静态类型检查。
- TypeScript 可处理已有 JavaScript 代码，并只对其中 TypeScript 代码进行编译。
