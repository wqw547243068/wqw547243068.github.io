...
【2023-5-18】[自动挡汽车驾驶10大技巧，老司机全讲给你，一次全学会](https://zhuanlan.zhihu.com/p/524608383)
- 车辆启动
- ![](https://pic4.zhimg.com/80/v2-a423d595cab6e3914804218d2b8b25b7_1440w.webp)
- 停车：手刹拉好后再挂入P档，这样下次启动比较方便。
  - 有些智能化汽车有自动驻车等功能，会一直到挂入P档
  - ![](https://pic4.zhimg.com/80/v2-3579eb73db7df5f999f5c77750c8a3fb_1440w.webp)
- 等红灯
  - 1）等待时间较短时（现在很多红绿灯都具备显示剩余时间功能），直接踩住刹车即可，不需要更换档位，保持在D档即可。
  - ![](https://pic2.zhimg.com/80/v2-6ea86477a259f043003c02a4581d5891_1440w.webp)
  - 2）等待时间较长(如40s)时，在踩住刹车的情况下，将车辆挂入N档即空档，这样可以切断车子的动力，对车子的保护更换，踩刹车也更省劲。
- 适当利用`M档`，不要`D档`一路到底
  - 一般驾驶不太熟练的车主，可能大部分时候都是一路D档，其他档位甚至从来没有用过，实际上不合理，既然设计了这些档位，就应该合理使用。
  - 在**路况较差**，或者**长上坡下坡**，或者想要**超车**时，可以将车辆切入M档，这时可以手动控制档位，适当增加扭矩，可以使车辆获得更大的动力。
  - 对老司机来说，想要获得**手动挡**的驾驶乐趣，体验单纯的快乐，那手动挡M档就很有必要了。
- 适当利用`N档`，也就是`空档`
  - 很多自动挡的车主，往往不知道用空档，也就是N档，实际上，N档在某些情况下还是有用的：
  - 1）等红灯的时候：如果等红灯的时间比较长的话，切换到N档，会有比较好的效果，我们刚才也讲过了；
  - 2）在平路停车的时候：比如碰到熟人说话，或者确保安全的时候查看车内情况等，可以切换到N档，这样也能比较方便。
  - 3）不要N档滑行：尤其在下坡的时候，某些车主以为换成N档会比较省油，但是不知道这时候是比较危险的，因为失去了发动机的牵引力制约，车子很容易失控。
- 善于利用自动驻车Auto Hold功能
  - 现在自动挡车子，有不少车型配置了**自动驻车**功能（Auto Hold，简称Auto H），开启后，在车辆速度经刹车变为零时，可以自动启动停车刹车功能，这样既不需要换成P档，也不需要一直踩着刹车，车子就会自动处于自动驻车功能。
  - ![](https://pic4.zhimg.com/80/v2-21ce700d981e2873364086248e812a2f_1440w.webp)
  - 启动Auto Hold功能后，在红灯等停车场合，就可以释放右脚，轻松自在。在重新启动的时候，只需要加油即可自动解锁，车子即可重新行驶。
  - 所以，如果你的车子具备这些功能，一定不要浪费了，用起来非常方便。
  - 当然，Auto Hold功能还有一个注意点，就是停车的时候，尤其需要多把才能停好的情况下，尽量关掉Auto Hold功能，因为会频繁切换档位，这样不让Auto Hold起作用，对多次调整停车还是方便的。
- 自动启停技巧
  - 大部分的车子都配置了自动启停功能，尤其是自动挡，该功能配置得更多。有些车主不喜欢这项功能，一方面觉着麻烦，另一方面觉着频繁启动发动机是不是更容易坏，所以大部分时候是上车就关掉这一个功能。
  - 合理使用自动启停功能，还是有好处的。
  - ![](https://pic2.zhimg.com/80/v2-0dedb5ea724ea11d777f5db3ae24ecb5_1440w.webp)
  - 1）如果长途在高速上开车，可以关掉该功能: 因为这种行驶场景，一般不会短期停车，即使到了服务区，那就是长期停车，不需要自动启停
  - 2）如果是短期交通拥堵，需要频繁移动车辆，可以关掉该功能: 因为这时候需要频繁地移动车辆，也就是会频繁地在停和动之间切换，如果打开启停功能，发动机就会频繁启停，会特别麻烦，对发动机不好，驾驶验也不好。
  - 3）在城市红绿灯道路通行，打开该功能: 交通路况也比较正常的情况下，自动启停是最好用的，尤其在一些红绿灯较长的路口，能有效节省油耗，提高停车时的舒适性。
- 定速巡航巧利用
  - 大部分自动挡汽车都配置了定速巡航功能，有些车还配置了自适应巡航功能，可以根据前车的状态自动调整巡航速度，所以，还是非常智能化的。
  - ![](https://pic3.zhimg.com/80/v2-774e39c5fe8737d975094fdbe6932486_1440w.webp)
  - 1）高速行驶，开启定速巡航: 在高速行驶时，由于路况较好，行驶速度高，这时候开启定速巡航，能有效降低右脚的长期踩油门的负荷，提高舒适性. 但是，如果驾驶员有疲劳感，则尽量不要开启定速续航功能，这样会增加危险的概率，另一方面也更容易让驾驶员犯困。
  - 2）城市道理，关闭定速续航: 城市道路路况复杂，需要频繁变更车速，不适合启动定速续航功能。
- 临时停车时不要轻易挂P档
  - 很多自动挡车型都有P档，有些还是电子P档，在真正停车的时候，可以使用P档确保停车稳定，相当于手动挡的手刹。
  - 但是在有些短时停车的情况下，要注意根据情况使用P档，不能轻易停车时就挂入P档，比如红绿灯的时候，挂入P档虽然省事，但是P档的状态下是由机械结构对变速箱进行锁定，这时候如果发生撞击等意外状况，会对汽车找造成伤害。
- 手不要一直放档把上
  - 自动挡车型不像手动挡那样需要频繁换挡，所以驾驶员不要养成把手一直放档把的习惯，这是某些开手动挡车型的驾驶员常有的习惯，但是自动挡是没有必要的，把手放档把上容易误触误碰，反倒容易出问题。
  - ![](https://pic1.zhimg.com/80/v2-9220a44f2c1f47a8219ce3af82111e5c_1440w.webp)

### 自动挡驾驶经验

【2023-7-22】海驾提供2h免费陪驾，经验总结
- 自动挡：没有`离合器`，左脚休息（有固定位置放），右脚在`刹车`和`油门`间跳转。
  - 一般配备360天眼，转弯就亮起，自动泊车，自动检测同向车距
  - 领克汽车自动挡：[link&co 02 轻跑](https://www.lynkco.com.cn/cars/02)
  - ![](https://dm30webimages.lynkco.com.cn/LynkCoPortal/Files/Cars/02HB/20221031/pc02.jpg)
- ① 起步准备：左右后视镜，上下1/2，左右1/4，座椅高度
- ② 起步：点火，打左灯，踩刹车时换挡（d），松手刹（按钮），左侧无异常时, 松脚刹即可启动
- ③ 行驶技巧：
  - 慢踩油门加速，点踩油门适合临时短期加速，下坡松油门踩刹车，转弯时减速，贴线，注意左右边距…
  - 方向把控：左侧a柱20cm最佳（左大灯凹槽处贴线），可看左右后视镜判断边距，转向要慢要稳，切记大幅度，回正后才可长踩加油…红绿灯前，车头别过停止线，会扣分罚钱…
  - 变道要提前打转向，确认安全后加速通过…不要长期并排行驶，时刻注意避让大车行人…
  - 左右直角转弯时，过人行横道线后再打方向，注意左右看…路口同向多车道时，转弯尽量避开最右侧车道（就给右转车）；路口直角转弯：目标道路边线过肩时再转向一圈
- ④ 掉头：虚线位置可调，窄路掉头，找空地，类似倒车入库
...
【2024-1-7】提升车感的几个[安全点位](https://www.ixigua.com/7309627046718603810)
- 车身中央：方向盘12点向右两指位置，就是车头中间；
  - 场景：遇到坑洼路段或井盖，需要压过来时，用这个点位对准坑洼位置就可以跨过去。
- 车身安全线：
  - 方向盘左边沿延伸出去，就是车身左侧安全线
  - 雨刮器节点位置，就是车身右侧安全线
  - 场景：过限宽墩、障碍物时，根据以上两个安全线判断是否会擦线
- 如何走直线？视线放远，只要感觉身体处于路中间就行。
- 转弯、出库何时转向？肩膀越过障碍物，打满方向，就不会剐蹭障碍物
- 倒车出库时，只要左右后视镜越过旁车，就可以打方向，不会剐蹭
- 路边停车，后面镜看不到后车车盖，只能看到前档剥离时，停车，此时车距刚好1m
...
【2024-2-3】[网传新版科目二](https://www.toutiao.com/video/7303487548335063567), 一共9项
- 倒车入库 → 8字绕弯 → 单边桥 → S弯倒车 → 坡道定点 → 侧方停车 → 窄路掉头
...
【2024-3-2】一张图看清油车与电车[区别](https://www.toutiao.com/w/7340436958893673762)
- ![](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/oEDAA33NbQAnDAODRJeg8bAcogDURCnGlIc9Ae~tplv-obj:1440:1920.image)

|类型|发动机|电机|加油|电池|充电|总结|
|---|---|---|---|---|---|---|
|燃油车|✅|❌|✅|❌|❌|通过发动机驱动,只加油|
|油电混合|✅|✅|✅|✅|❌|发动机/电机一起驱动，电池很小，只加油|
|插电式|✅|✅|✅|✅|✅|发动机/电机一起驱动，电池中等，既能加油又能充电|
|增程式|✅|✅|✅|✅|✅|电机驱动,发动机发电,既能加油又能充电|
|纯电车|❌|✅|❌|✅|✅|电机驱动,电池很大,只能充电|
...
北京摇号规定一年两次，一般一个北京户口可以摇号两次。 

#### 北京摇号信息

根据《北京市小客车数量调控暂行规定》，只有名下没有本市登记的小客车且持有行驶执照的个人才有资格参加摇号。 如果同时申请**普通指标**和**新能源指标**，一年就有3次获得指标的机会。
- 新能源小客车摇号时间：5月26日
...
- ☑ `新能源车`：一年一次配置结果
  - 配置时间：**5月26日**上午10:00, 新能源指标配置
  - 配置结束后，申请人可在系统登录后进入用户中心，在配置指标功能区点击“我的个人申请”查询配置结果;
- ☑ `普通小客车`：一年摇2次。
  - 摇号时间分别为：**6月26日**和**12月26日**上午10:00进行普通指标摇号
  - 配置结束后，申请人可在系统登录后进入用户中心，在配置指标功能区点击“我的个人申请”查询配置结果。
...
- (一) **本市户籍**申请条件
  ...
  - 注：持有有效《`北京市工作居住证`》的非本市户籍人员，申请条件同本市户籍一样。
- (二) **非本市户籍**申请条件(无工居)
  - 前3条同上
  - 4、持有北京市有效`居住证`;
  - 5、近**五年**(含)连续在本市缴纳社会保险和个人所得税。

注1：
- “近五年(含)连续在本市缴纳社会保险”是指：申请月的上一个月开始往前推算60个月连续，不能断月(如有断月，补缴后有效)。

### 车牌租赁

北京租车牌分为两种形式，即**短租**（1—5年）、**长租**（10年、20年）背户。

2022年，北京车牌一年租金**1.3万元**。
- 如果能租20年，价钱最便宜，相当于每年收你3500元租金。

如果**租户**和**车牌主**双方见面互相满意，那么接下来的流程就是签合同、办手续。
- 据了解，在黑中介所签的合同主要内容包括，租户拥有**车辆使用权**、**行驶权**，如果发生交通事故，应承担所有相应责任，而车牌出租方无权擅自将车辆出售。
- 以**车牌主**名义全款买一辆新车/二手车，然后到`车管所`备案办理登记手续。这种车牌租赁业务可以到车管所备案，其潜台词就是：“车管所可以保护你们的利益。”

## 进京证

【2024-2-25】外地车进京需要办理`进京证`
- 只能在**二环以外**行驶，否则, <span style='color:red'>2分200块</span>。
- 即便有进京证，不是所有地方都能去。

进京证不是想办就能办
- 六环内的进京证每年只能办理**12次**，每次只能使用**7天**，所以进京车辆一年内最多只能在六环内行驶**84天**。
- 只有京**A牌**照的摩托车能在**二环内**随意通行，所以京A摩托车牌能在县城换套房真不是吹的。
