...
传统强化学习任务中，通过计算累积奖赏来学习**最优策略**（policy），这种方式简单直接，而且在可以获得较多训练数据的情况下有较好的表现。但是，`多步决策`（sequential decision）中，学习器不能频繁地得到奖励，且这种基于累积奖赏及学习方式存在非常巨大的搜索空间。

没有reward的情况下，让AI跟环境互动的一个方法叫做 `Imitation-Learning`
...
Behavior-Cloning跟监督学习有类似之处，也是复制人类行为。
...
原文链接：https://blog.csdn.net/tianjuewudi/article/details/120684729
