...
- 语言模型出现幻觉的根本原因：训练和评估过程**奖励猜测**，而不是承认不确定性
...
【2025-12-26】[别再怪SFT了！清华揪出0.1%幻觉神经元：大模型胡编的尽头，其实是过度顺从](https://mp.weixin.qq.com/s/u9vgvO78GOWAu7N4bChcOg)
...
- 论文标题：[H-Neurons: On the Existence, Impact, and Origin of Hallucination-Associated Neurons in LLMs](https://arxiv.org/pdf/2512.01797)
...
不仅找到了与幻觉相关的**极少数神经元**（H-Neurons），更揭示了令人意外的真相：
