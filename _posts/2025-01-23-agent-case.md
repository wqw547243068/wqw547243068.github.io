...
论文信息
- 标题: [AgentMental: An Interactive Multi-Agent Framework for Explainable and Adaptive Mental Health Assessment](https://arxiv.org/pdf/2508.11567)
...
【2026-1-9】滴滴上线AI小滴助手 [滴滴上线AI叫车，终于有懂我的出行AI了](https://mp.weixin.qq.com/s/lu1c5zPFBenTKVjDHIHMZw)
...
- MCP 传送门：[MCP](https://mcp.didichuxing.com/api)


#### 论文

【2025-2-12】港科大（滴滴实习）+DiDi KDD 新作：LLM驱动的智能打车助手DiMA
- 📚论文标题: [DiMA: An LLM-Powered Ride-Hailing Assistant at DiDi](https://arxiv.org/abs/2503.04768)
...
小红书用户反馈
- [实测滴滴AI：打车更累了，已疯](https://www.xiaohongshu.com/explore/68d50923000000001301ef84)
...
5月6日，OpenAI官方[文章](https://openai.com/zh-Hans-CN/index/uber/)，Uber 借助 OpenAI搭建 AI 助手及语音功能（OpenAI Realtime API ），助力司机高效增收，提升乘客预订体验。
...
【2025-8-8】京东零售 `Oxygen` 团队正式开源发布**多智能体协作框架**——`OxyGent`。

当前多智能体开发仍面临诸多挑战：框架生态碎片化、配置调试复杂、智能体协作逻辑“黑盒”，使得构建和维护多智能体系统对个人开发者和中小团队而言成本高昂。社区亟需更简单、灵活的解决方案。

京东零售Oxygen团队基于在AI应用的长期积累，正式开源多智能体协作框架`OxyGent`——将工具、模型和智能体抽象为可插拔的原子算子Oxy，支持开发者像搭积木一样灵活组合多智能体系统，具备极致可扩展性和全链路决策追溯能力。
- 通过构建-推理-进化的闭环智能体流水线，OxyGent实现了Oxy无缝集成、弹性扩展和持续优化，为AI生态发展提供全新可能。

这一创新框架致力于帮助开发者高效组装多智能体协作系统，实现**智能体间**的无缝协作、弹性扩展与全链路可追溯。

推动人工智能从“单点突破”迈向“群体智能”时代。

OxyGent 已在开源社区正式上线。
- 开源地址：[OxyGent](https://github.com/jd-opensource/OxyGent)
- 官网地址：[OxyGent](https://oxygent.jd.com)
- 在线体验：[demo](https://modelscope.cn/studios/J)
...
![](https://pic3.zhimg.com/v2-4ec5103210562fbaaf07ae6e397921f2_1440w.jpg)
...
- [GAIA](https://huggingface.co/spaces/gaia-benchmark/leaderboard)（General AI Assistant）Benchmark 
