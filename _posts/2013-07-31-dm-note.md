...
categories: 数据挖掘
tags: 数据挖掘 机器学习 数据分析 陈皓 大数据 增长黑客 数据金字塔 sql zepplin hadoop hive tez spark storm 服务质量 评分卡 clickhouse kafka 消息队列 mq zookeeper 数据库 mysql NPS 统计学 excel vlookup 贝壳分 互信息 熵 皮尔逊 肯德尔 pearson kendall 爬虫 json 加密  幸存者偏差 百度 
