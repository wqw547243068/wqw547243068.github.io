...
Kimi Residual Attention 一作[陈广宇](https://nathanchen.me/public/About%20me.html)是高三学生
- I'm a high school **rising senior** （准高三） from China. 
...
To make everything easy we will use **hand-drawn flowcharts** （手绘流程图） and simple calculations to help clarify your concepts from the **ground** up （从基础开始）.
...
您好，
- 由于您的下属 *** 已在DHR系统提起离职，已自动触发信息安全部预离职人员权限审核流程。(请使用电脑端访问，手机端不支持review操作)
- 系统将在 2026年04月26日 11时00分 自动回收 全部权限。如需保留，您可登陆upm对 权限进行保留确认
- 权限操作入口：

*信息安全提醒：
- 为避免安全违规事件发生，降低信息泄露风险，请遵守权限最小化原则，只保留离职交接期间必要权限，谢谢！

Hello, The permission authority（权限） review process（审核流程） has been automatically triggered（触发） due your subordinate（下属） huangzi has raised resignation（提起离职） in DHR system.(Please use the computer to access. The mobile phone does not support the review operation)

The system will automatically reclaim（回收） all huangzi permissions at Sun Apr 26 2026. If you need to keep it, you can log in to UPM to confirm the permission of huangzi

Permission operation entrance: http...

*Information Security Alert:
- In order to avoid security violations（安全违规） and reduce the risk of information disclosure（信息泄露）, please follow the principle of minimizing authority（最小信息原则） and only retain（保留） the necessary authority during the handover（交接） of resignation. Thank you!


Information Security（信息安全） Reminders（题型） for the Resignation Period（离职期间）

Dear ,
- The Information Security Department（信息安全部） has learned that an employee under your supervision（管辖部门内员工）, “黄**”, has submitted a resignation request（离职申请）.
- To prevent the risk of data leakage（数据泄露） during the notice period, the Information Security Department will block all external file‑sending and uploading channels（封禁办公电脑外发+上传渠道） on “黄(huangzi)”’s office computer — such as third‑party software clients and web interfaces—and restrict certain DC functions on mobile devices following the issuance of this notice.
- To facilitate resigning employees in handling software unblocking and private‑file export matters, the relevant reporting procedures have already been communicated to them. If a resigning employee submits such requests, please exercise caution in handling them!
The Information Security Department reminds you to inform the resigning employee of the following company information‑security obligations:
- Under the confidentiality agreement, whether employed or no longer an employee, you are obligated to（有义务） safeguard the company’s trade secrets and internal information.
- Any company materials, manuals or other documents obtained, accessed or produced during employment—regardless of whether they contain confidential information—must not be copied, retained or distributed in any form without authorization.

Notes:
- A. If a device is mistakenly blocked, or if issues arise during the reporting process, please contact the Information Security Assistant for feedback and assistance.
- B. If any information‑security violations are discovered during the resignation period, the company will elevate the incident to a higher security level under the “Didi Chuxing Information Security Incident Handling Procedure” and will take strict disciplinary action.

Thank you for your understanding and support of the company’s information‑security efforts!
