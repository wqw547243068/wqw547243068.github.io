---
layout: post
title:  "论文阅读+最新信息获取-Paper-Club"
date:   2020-06-11 10:48:00
categories: 技术工具
tags: 深度学习 自然语言处理 sota 元学习 BLEU 谷歌 OOD 分布外泛化 爱可可 李沐 huggingface 专利 硕士论文 造假 大模型 openclaw hermes 营销
excerpt: 最新技术、资讯获取方法，论文 sota(the state of the art), 资料汇总
author: 鹤啸九天
mathjax: true
permalink: /paper
---
...
- 全球AI热门动态：[AI Hot](aihot.virxact.com), 实时抓取外网最新AI资讯（精选/动态/日报），LLM自动筛选、判断，支持多种安装方式（RSS/Rest API/Skill）
  - `帮我安装这个 skill：https://aihot.virxact.com/aihot-skill/`
  - 示例："今天 AI 圈有什么新东西"、“最近3天大模型进展”
- 国内全平台热搜聚合：[News Now](newsnow.busiyi.world) 社会新闻实时抓取展示
- X（推特）爆款监控：[hot tweets](sopilot.net/zh/hot-tweets)
- 全球AI热门提示词：[You Mind](youmind.com/zh-CN/prompts)

直接把 “复刻爆款与发布” 做成了一条标准生产线：
- [刻鸦AI](ky.ithinkai.cn) ：监控爆文、原创改写、一键发布全搞定

小红书竞品监控：自动追踪对标账号内容更新
- 设一次规则，系统自动监控小红书对标账号发文、互动数据和爆款变化，结合 AI 洞察输出飞书日报，让团队第一时间发现竞品内容变化。
- 效果演示 [MediaClaw](https://mediaclaw.app/xiaohongshu/monitoring)
...
【2026-5-20】好新闻分散在各处，坏信息却源源不断。[Horizon](https://thysrael.github.io/Horizon/) 为你先完成第一轮筛选：
...
[Horizon Github](https://github.com/Thysrael/Horizon/blob/main/README_zh.md)

<img width="883" height="100%" alt="image" src="https://github.com/user-attachments/assets/74e6c059-a30b-4511-a0f1-bc733eecc26a" />
...
【2026-6-6】[sophon](http://sophon.at)
...
【2026-8-30】新闻报道滞后。[World Monitor](https://www.worldmonitor.app/) 将世界的原始信号 — 船舶、飞机、警报、电缆、市场 — 流式传输到一张实时地图上，配有 AI 技术，可在它们汇聚成重要信息时发出标记
- [实时仪表盘](https://www.worldmonitor.app/dashboard?zoom=1.00&view=global&timeRange=7d&layers=conflicts%2Cbases%2Chotspots%2Cnuclear%2Csanctions%2Cweather%2CcanadaAlerts%2Ceconomic%2Cwaterways%2Coutages%2Cmilitary%2Cnatural)
- GitHub项目：[worldmonitor](http://github.com/koala73/worldmonitor)

![](https://www.worldmonitor.app/pro/assets/worldmonitor-7-mar-2026-1280-DPT55fI_.avif)
...
LLM驱动的论文检索工具 [paper-qa](https://github.com/Future-House/paper-qa/tree/main)
...
- ![](https://github.com/bytedance/pasa/raw/main/src/architecture.png)

由大语言模型驱动的论文搜索`AgentPaSa`。

PaSa 能自主作出一系列决策，包括调用**搜索工具**、**阅读论文**和**选择相关参考文献**，以最终获得**复杂学术查询**的全面和准确结果。利用合成数据集 AutoScholarQuery 对PaSa进行了**强化学习**优化，该数据集包括35000个详细的学术查询及其对应的论文，这些论文来自顶级AI会议的出版物。
...
- 【2025-4-3】加拿大多伦多大学 论文：[Scaling Laws in Scientific Discovery with AI and Robot Scientists](https://arxiv.org/pdf/2503.22444)
...
1. 核心创新点
- ⭐️ 提出“自主通用科学家”（AGS）概念：把 AI大脑 和 机器人身体 结合，从**查文献**、**想创意**、**做实验**到**写论文**，全流程自动化，再也不用靠人类苦哈哈熬夜肝科研
- ⭐️ 给AI科学家“分级考试”：从 Level 0 **纯人工**到 Level 5 **完全自主**（比如极端环境搞科研的超级机器人），清晰划分6个等级，帮大家看懂AI科研助手的进化进度
- ⭐️ 打通虚拟+物理世界壁垒：以前 AI只会处理数据，现在搭配机器人能动手做实验, 比如在实验室配溶液、操作显微镜”
	
1. 技术亮点
- ⭐️文献调研会“翻墙”：用**OS Agent**模拟人类上网，突破付费墙查文献，还会自动整理热点和研究空白，比人工查资料快10倍不止
...
【2026-4-15】[hermes 会替代 openclaw 吗](https://www.zhihu.com/question/2026454682885791949/answer/2027598961205157984)

Hermes 非常适合承接这种长期运行、跨多步骤、带真实外部投递的 agent 任务

基于 Hermes 的 agent skill：项目 [hermes-arxiv-agent 的 AGENT_SKILL.md](https://github.com/genggng/hermes-arxiv-agent/blob/main/AGENT_SKILL.md)
...
![](https://picx.zhimg.com/80/v2-0bc89cb523eaaf68bd044bafbe388946_720w.webp?source=2c26e567)

本地阅读网站效果

![](https://pic1.zhimg.com/80/v2-1815ee40b8ed251054d224d8d42670c9_720w.webp?source=2c26e567)
...
【2020-6-11】阿里员工开发的论文知识图谱可视化检索工具 [connectedpapers](https://www.connectedpapers.com/)
- ![](http://p1.pstatp.com/large/pgc-image/37054b2db9b64394a73feecfa9ad024d)

#### soarXiv

【2025-5-20】[Jinay Jain](https://jinay.dev/) 推出 [soarXiv](https://soarxiv.org/) - the universe of science
- 原理: 收集截止 2025年5月的**280万**篇论文, 用 UMap 嵌入到三维空间, 用 three.js 可视化, 绘成**星空图**，输入arXiv地址即可探索
...
- 输入论文地址, 定位到星空位置
- ![](https://www.dalao.net/upload/attach/202505/6_1747740522530.webp)
...
【2023-11-6】知网论文、期刊、专利认领，[地址](https://au.cnki.net/author/workbench/personalHomePage/000058040841)
- [作者服务平台](https://au.cnki.net/author/workbench/myIntegral)：已有2篇期刊，9篇专利
...
- 计算机工程学报：[基于形态学的小鼠舌头切片图像分割与实现](https://jz.docin.com/p-533278994.html)
  - 知网[地址](https://kns.cnki.net/kcms2/article/abstract?v=AnKLoVmldNRm-0SXBHNX95RpiolXdNPm4x1lWcyh4BvQ4wxdRNvxGWVNt4XlI9--Jv2sBMhBMkzdAE4uiWKaYicftkmCe43Rg46Qwe7xjWqSwkTDRlOjM2W1Y0-FpmjfOJ-9RZtGohI=&uniplatform=NZKPT&language=CHS)
  - 发表时间 2011-06-20 13:39，被引用 6，	下载 191
- 基于中科院的三维重建开源软件做二次开发，软件著作权，[天眼查](https://banquan.tianyancha.com/rj/1eoe14188e08bba17ee55010el91e2b7)

【2023-11-6】[知网最新通知：这些人可以领稿酬了](https://m.gmw.cn/2023-07/21/content_1303449779.htm)

[知网个人主页](https://au.cnki.net/author/personalInfo/000058040841)
- 专利[认领地址](https://au.cnki.net/author/workbench/searchclaim)
...
SooPAT网址, 国家知识产权局入口：[中国及多国专利查询](http://cpquery.cnipa.gov.cn/)
- [作者服务平台](https://au.cnki.net/author/workbench/myIntegral) 已有9篇
- [专利检索与分析](https://pss-system.cponline.cnipa.gov.cn/retrieveList?prevPageTit=changgui)


历史专利
- 【阿里-高德】**一种用户满意度评分方法及装置** -- 搜索满意度自动评估
  - [专利局](https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui), [soopat](http://www.soopat.com/Patent/202010147299), [知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN109582744A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【滴滴】**一种信息处理方法及装置** -- 对话意图关联识别
  - [专利局](https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui), [soopat](http://www.soopat.com/Patent/201811488865)，[知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN111858846A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【滴滴】**模型训练方法、咨询推荐方法、装置及电子设备**  -- 多任务学习
  - [专利局](https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui), [soopat](http://www.soopat.com/Patent/201811488865),[知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN111291253A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【滴滴】**一种智能对话方法和系统** -- 基于kb-qa的问答
  - [专利局](https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui), [soopat](http://www.soopat.com/Patent/202010618702)，[知网](SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【贝壳】**文本处理方法、装置、计算机可读存储介质及电子设备**  -- 一种无监督文本问答评价打分方案
  - [soopat](http://www.soopat.com/Patent/202110299495)
- 【贝壳】**对话机器人的主动对话方法、装置、电子设备及存储介质**
  - [专利局](https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui), [知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN115731915A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【贝壳】**信息差异的识别方法和存储介质、电子设备** —— 房江湖
  - 郝梦圆; 柴鹰; 王奇文
  - [专利局](https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui)
-  【贝壳】**文本处理方法、装置、计算机可读存储介质及电子设备**
  - [专利局](https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui), [知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN112800230A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)


### 学术造假


【2024-1-28】原来我们都是学术造假的受害者。[学术造假影响的不止是学生，而是我们所有人](https://m.toutiao.com/is/iLssQssN)
- `阿兹海默症`为什么到现在都治不了？2006年奠基性的学术论文造假，导致以后16年的研究都有问题。全球老年痴呆领域的科学家16年的心血和上百亿的研发资金全部化成泡影。
- 几年前，**喝红酒有益健康**的言论被多少人奉为了真理，真相却是该言论的提出者哈佛教授通过他的红酒庄园得到了巨大的利益。直到2018年，哈佛教授这一言论才被推翻。
- 华中农大被举报的教授黄某某所提出的`三竹醇`几乎是十分全能的添加剂，能全方位改善家畜家禽的生长、繁殖甚至口感。但研究生发现，该物质至今来源不明，学生也从未见过实际提取物，而且售价非常高，一克80万的添加，若将这种虚假的东西投入市场上下产业链将获得多么庞大的利益，动物和消费者也都将受到伤害。这群少年赌的不只是他们自己的前途，他们是在揭露这场无限大的阴谋。
