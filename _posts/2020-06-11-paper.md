...
- 【阿里-高德】一种用户满意度评分方法及装置：搜索满意度自动评估
  - [soopat](http://www.soopat.com/Patent/202010147299), [知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN109582744A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【滴滴】一种信息处理方法及装置：对话意图关联识别
  - [soopat](http://www.soopat.com/Patent/201811488865)，[知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN111858846A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【滴滴】模型训练方法、咨询推荐方法、装置及电子设备：多任务学习
  - [soopat](http://www.soopat.com/Patent/201811488865),[知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN111291253A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【滴滴】一种智能对话方法和系统：基于kb-qa的问答
  - [soopat](http://www.soopat.com/Patent/202010618702)，[知网](SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
- 【贝壳】文本处理方法、装置、计算机可读存储介质及电子设备：一种无监督文本问答评价打分方案
  - [soopat](http://www.soopat.com/Patent/202110299495)
- 【贝壳】 对话机器人的主动对话方法、装置、电子设备及存储介质
  - [知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN115731915A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
-  【贝壳】文本处理方法、装置、计算机可读存储介质及电子设备
  - [知网](https://x.cnki.net/xmlRead/pdf.html?pageType=pdfweb&fileName=CN112800230A&tableName=SCPDTOTAL&dbCode=SCPD&topic=&fileSourceType=1&taskId=&from=&groupId=&appId=CRSP_BASIC_PSMC&act=&customReading=)
