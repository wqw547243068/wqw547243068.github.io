...
【2025-8-23】[RAG 已死，上下文工程当立](https://news.qq.com/rain/a/20250823A05YNP00)

Chroma 的创始人 Jeff Huber 最新访谈视频，专业做向量数据库，对RAG的理解透彻。
- [youtube视频](https://www.youtube.com/watch?v=pIbIZ_Bxl_g)
...
当前的 AI 应用中存在着严重的**上下文腐烂**的问题。
- 当模型的上下文窗口中存在着更多 Token 时，模型的**注意力会下降**，推理能力也会随之减弱。
...
[PageIndex](https://pageindex.ai/) 是开创性、无向量、基于推理 RAG 系统，从长文档中构建分层树索引，并使用大语言模型通过树搜索进行智能体化的、上下文感知的检索。
...
【2026-2-6】给 Agent 定义一套极简的上下文交互范式，让开发者彻底告别上下文管理的烦恼。 
...
<img width="1080" height="1492" alt="image" src="https://github.com/user-attachments/assets/bda3381f-a70f-4046-8756-6cad2e4e9bd1" />
...
<img width="870" height="1116" alt="image" src="https://github.com/user-attachments/assets/bd7854d6-e7bb-4d9c-ac93-f3e945e46623" />
...
- 论文 [Youtu-GraphRAG: Vertically Unified Agents for Graph Retrieval-Augmented Complex Reasoning](https://arxiv.org/abs/2508.19855)
...
![](https://pic1.zhimg.com/v2-89b3f661e5b0ff21a6f76b1c2804f428_r.jpg)


## Deep GraphRAG

【2026-1-19】蚂蚁集团和浙江大学的研究人员开发 Deep GraphRAG，结合**分层全局到局部**检索策略和**动态加权**强化学习方法（DW-GRPO）的框架，增强大型语言模型在复杂知识图谱推理方面的性能。
- 论文 [Deep GraphRAG](https://www.alphaxiv.org/zh/overview/2601.11144v2)
...
【2025-9-13】[Meta REFRAG框架详解，实现30倍加速与16倍上下文扩展（Context Engineering）](https://zhuanlan.zhihu.com/p/1950147966871533479)
...
<img width="1080" height="467" alt="image" src="https://github.com/user-attachments/assets/cacd11cf-8695-430c-813c-8c5290f7f561" />
...
https://arxiv.org/abs/2509.01092a

<img width="944" height="1108" alt="image" src="https://github.com/user-attachments/assets/13f4c594-0415-4916-bc35-79c1bcb5a5fb" />
...
【2026-1-15】[GAG：超越RAG，无需检索的私有知识注入新范式](https://www.toutiao.com/article/7595457502796349967)
...
- 【2206-1-13】[Generation-Augmented Generation: A Plug-and-Play FrameworkforPrivate Knowledge InjectioninLarge Language Models](https://arxiv.org/pdf/2601.08209)


受**多模态大语言模型将异构模态对齐至共享语义空间**思路的启发，提出生成增强生成（GAG）方法。
...
[img](https://p3-sign.toutiaoimg.com/tos-cn-i-ezhpy3drpa/f855c6b2d8cb42349207120e7a4686fd~tplv-tt-origin-web:gif.jpeg)

![](https://p3-sign.toutiaoimg.com/tos-cn-i-ezhpy3drpa/f855c6b2d8cb42349207120e7a4686fd~tplv-tt-origin-web:gif.jpeg)
