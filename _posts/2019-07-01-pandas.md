...
【2026-8-13】Mac 下加载日期异常
- `2026年1月3日` --> `46024`


```py
base = pd.Timestamp("1899-12-30")
res = base + pd.Timedelta(days=46024)
# 输出：2026‑08‑12 00:00:00

# 函数版
def timeTransform(a: int)->str:
    base = pd.Timestamp("1899-12-30")
    res = base + pd.Timedelta(days=a)
    return res.strftime("%Y-%m-%d")

res = timeTransform(46024)
print(res)
```

常见踩坑补充
- Mac 版 Excel 基准是 1904‑01‑01，偏移改为 `pd.Timestamp("1904‑01‑01")`
- 如果带有时分秒，数值带有小数 `46024.685`，小数代表当天占比
...
作者：[GPZ_Lab](https://www.jianshu.com/p/38a66299d105)
...
go语言版本的 pandas 工具包
- [Gota](https://github.com/kniren/gota) 实现了 DataFrames, Series
- [Gonum](https://www.gonum.org/) 面向机器学习+统计, github [gonum](https://github.com/gonum/gonum)
- [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) 复现了 pandas 的 dataframe 操作
...
作者介绍: [Dataframes for Go](https://medium.com/@rocketlaunchr.cloud/dataframes-for-go-b1f26f523ab9)
