...
categories: 新技术
tags: 区块链 比特币 张首晟 桥水基金 加密 智能合约 零知识证明 usdt
...
【2025-7-7】[【小白也能懂】USDT是什么？能当钱用吗？用它跨境支付合法吗？](https://zhuanlan.zhihu.com/p/1925492639240795352)

### 什么是 USDT

USDT 全称 Tether USD，一种「锚定美元的稳定币」：
> 1个USDT ≈ 1美元。

运行在区块链上（最常见TRC20链），不像`比特币`那样价格波动大，核心目的是充当数字美元。

很多人当作数字钱包里的美金，可跨国转账、收款、买服务等。

USDT可以当“钱”用吗？可以，但前提是：
- 对方/平台接受USDT支付；
- 知道如何用钱包收发；
- 明白背后的法律边界。
...
|------------|-------------------------------------------|--------------------|
| 本质       | 区块链数字资产                           | 法定货币           |
| 支持机构   | Tether公司（注册在英属维京群岛）| 美国财政部         |
| 使用方式   | 区块链钱包转账（如TRC20）| 银行账户或现金     |
| 汇率稳定性 | 锚定1:1（但非100%等同）| 国家信用背书       |

### 类型

USDT 三种形态：
- 基于比特币网络的O mni-USDT，充币地址是BTC地址，充提币走BTC网络；
...
USDT跨境支付违法吗？使用USDT本身不是违法，但关键在于：
- ✅ 你有没有从合规平台买卖USDT（如交易所）
- ✅ 你有没有通过正规路径换成人民币（比如C2C交易）
- ❌ 如果你通过“地下钱庄”“洗钱通道”去兑换人民币，那就是风险行为。

⚠️ 注意：国内严禁“数字货币作为支付手段”，但持有USDT本身目前并不违法。

总结
- USDT 是一种“数字版的美元”，适合做高效、灵活、国际化的支付手段。
- 但一定要知道它不是万能“提款机”，用对场景、守住合规，才是长期稳定用它的关键
