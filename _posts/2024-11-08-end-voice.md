...
### 【2026-8-28】PhoneLLM Alpha 客服

【2026-8-28】Pipecat 刚发布 PhoneLLM Alpha 1，就是冲着这种场景来的。
...
同时发布 PhoneBench，评估电话 Agent 的对话质量、工具调用、say/do 一致性、事实 grounding、认证与升级处理等指标，并把延迟和运行成本也纳入评估。

在 PhoneBench 上，和 `GPT-5.6 Terra` 几乎打平，72.3% vs 72.4%；但 P95 首 token 延迟快约 1300ms，成本大约只有 1/18。放到完整的语音链路里，延迟也能压到自然对话可以接受的范围。
...
- Hugging Face：[pipecat-ai/phonellm-alpha-1]()，BSD 许可
