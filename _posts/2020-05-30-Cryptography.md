...
- 3️⃣ 2010 年 4 月，硬盘原封不动退还给巴西，里面的数据依旧锁得死死的

当年用的是 TrueCrypt，免费开源。

结果 2014 年开发者突然把项目关了，官网就扔下一句“TrueCrypt 不安全”，原因成谜，谁也不知道内情。

接盘的是个法国密码学家 Mounir Idrassi，斯诺登事件爆发后第 17 天，他发布了 [VeraCrypt](https://veracrypt.jp/)
- GitHub [VeraCrypt](https://github.com/veracrypt/VeraCrypt)。
- 纯 C 语言写的，一直在更新。

2016 年开源技术改进基金会请 QuarkSlab 逐行审计了一遍源码，揪出的漏洞，Idrassi 在 v1.19 版本全修完了。

跟市面上一众全盘加密软件最本质的区别：背后没有哪家公司攥着密钥，也没有云端备份，法院下禁令也解不开。单个文件、文件夹、U 盘、整个系统盘，想加密什么都行。

还能藏一个隐藏卷——有人拿刀架你脖子上逼你交密码，他看到的就是一堆诱饵，真正的秘密依然纹丝不动。

数学就是那把锁。免费，开源，经得起公开审计。
