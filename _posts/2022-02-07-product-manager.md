...
categories: 互联网
tags: 互联网 产品 MVP PMF B端 C端 增长 运营 营销
excerpt: 互联网产品经理工作内容
author: 鹤啸九天
mathjax: true
permalink: /product
...
大部分产品死于没用户，不是产品不够好。花 6 个月打磨产品，上线后发现就几个注册，不是朋友就是亲人、还有一些误点进来的。这可能不是你的问题，是方法错了。

《拉新》整理了更有效的实战手册。适合独立开发者和自媒体，都是具体打法，没废话！
- 1）50%法则（最重要）
- 2）靶心框架（找到你的核心渠道）
- 3）19 种渠道速查
- 4) 可复制的 SOP
...
不要 19 个都做。找到 1 个有效的，就够了。

书里的案例：Mint 用博客投稿，Dropbox 用病毒裂变，DuckDuckGo 用 SEO。每家的核心渠道都不一样。

但他们都做对了一件事：50% 时间找用户。

分享给你，希望有用，感恩点赞、收藏、转发！

笔记来源：《拉新》by Gabriel Weinberg，书里有 40+ 真实案例和完整方法论，值得一读！

#### 50%法则

1）50%法则（最重要）
- 50%时间**做产品**，50%时间**找用户**。
- 不是先做好产品再推广，是**边做边测试**渠道。

为什么？
- 因为可能正在「往破桶里倒水」。产品有漏洞，早期用户会告诉你哪里漏了， 修补→测试→再修补。

Mint 在产品发布前就积累了几万用户，6 个月后破百万。

怎么做的？一边开发，一边测试博客软文、SEO、社交广告。

如果现在 100% 时间在写代码/做内容？停下来
...
别无脑乱试，可用这个三步框架：
- 外环 - 列出所有可能
  - 在表格里列出 19 种渠道（下面会讲），针对每个写下：如果成功会是什么样子？需要什么资源？
  - 别跳过任何一个。你觉得不可能的，或许往往最有效。
- 中间环 - 小成本测试 3-5 个
- 选最有希望的 3-5
...
零成本启动（$0-100）
- a) 目标博客投稿 - 找你用户看的内容平台，主动写稿或赞助
- b) 社群混脸熟 - 不是建群，是混进去真诚帮人
- c) 内容营销 - 写干货不写广告，公式是70%干货+20%故事+10%产品
- d) 社交媒体 - 在你用户活跃的平台持续输出
- e) 公关曝光 - 给科技媒体/行业媒体投稿或接受采访

小成本测试（$100-1000）
- a) 搜索引擎优化 - 做长尾词不做大词，3-6个月见效
- b) 社交/展示广告 - 先自然传播，反响好再投点钱加热
- c) 线下活动 - 行业聚会、meetup、沙龙混脸熟
- d) 行业大会/展会 - 不一定要展位，混进去发名片也行
- e) 冷启动奇招 - 做点创意营销，成本低传播广

中等投入（$1000-5000）
- a) 搜索引擎营销 - 关键词广告，快速测试产品定位
- b) 线下广告 - 本地杂志、传单、公交站，有追踪码
- c) 网盟/信息流 - 按展示或点击付费的广告网络
- d) 代理/经销商 - 找能接触你用户的渠道伙伴
- e) 销售团队 - 直接陌生拜访或电话销售

大额投入（$5000+）
- a) 电视/广播 - 适合大众产品，要能追踪效果
- b) 杂志/报纸 - 传统媒体，选对的话ROI不错
- c) 户外广告 - 地铁、高速路牌、电梯广告
- d) 病毒裂变 - 产品内置分享机制，设计成本高但边际成本低

建议：先测试前10个，至少有3-5个适合你。
...
- 预算 1000 块以内
- 1 个月内能看到结果
- 回答三个问题：获客成本多少？能带来多少人？这些人对吗？

比如：内容营销（发 3 篇干货）+ 社群（混 5 个相关群）+ 冷启动（做个小活动）。
...
如果内容营销效果最好，CAC 不到5块，而且用户都是精准的。

第 5 步开始：ALL IN！

其他的停掉或者降到最低，专注把最有效的那个做到极致。
...
坑1：什么都试一点
- 作者最开始 10 个渠道每个投 10% 精力，结果每个都做得稀烂。后来砍到只做 1 个，反而起来了。

坑2：太早放弃
- 内容营销前 2 周只带来 20 个用户，差点放弃。坚持到第3个月，单篇内容能带来 500+ 用户。多数渠道要 3-6 个月才见效。

坑3：只做自己会的
- 作者是技术背景，一开始只想做 SEO 和技术社区。后来试了内容营销（原本觉得自己不会写），反而这个最有效。
