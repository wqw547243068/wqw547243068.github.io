...
【2026-7-9】目标检测和跟踪领域的黄金组合：[YOLO+卡尔曼滤波](https://zhuanlan.zhihu.com/p/1914034506614158292)
- 论文 [Vision‐Based UAV Detection and Tracking Using Deep Learning and Kalman Filter]()
- 方法：基于YOLO检测和卡尔曼滤波跟踪的无人机视觉检测系统。先用YOLO系列算法检测无人机并分类，再用卡尔曼滤波修正轨迹，提高跟踪精度和鲁棒性。

![](https://picx.zhimg.com/v2-69999715a0b3055f7cf2bb9217594019_1440w.jpg)
...
【2025-5-20】[安全生产视频监控系统 开源！ 将普通摄像头转变为AI 智能摄像头](https://mp.weixin.qq.com/s/ml5UV0gCQqQ9K4FKx09jIg)

将生成式AI与边缘计算相结合的创新平台，通过智能化改造传统摄像头，为高风险行业提供了**高效**、**实时**且**低成本**的安全解决方案
- 源代码 [project-gpp](https://www.gitpp.com/digigg/project-gpp-19050119909)

摄像头在本地设备上，即可完成数据处理与分析，自动补偿放大，**无需依赖云端**，从而实现了低延迟的实时响应，显著提升了数据安全性与隐私保护能力。

在应用场景方面，广泛适用：
- 钢铁冶炼行业：平台能够精准识别生产过程中的潜在风险，如设备异常、操作不当等，助力企业及时采取措施，确保生产安全。
- 智慧工地领域：通过智能化改造，普通摄像头即可实现高清放大功能，对工地现场进行细致入微的监控。平台还能自动聚焦工人是否佩戴安全帽等关键安全要素，有效预防安全事故的发生。
- 化工厂安全生产监测：在化工领域，平台能够实时监测生产环境中的安全隐患，如泄漏、火灾等，为企业的安全生产提供有力保障。

案例
- 钢铁冶炼：识别并发现生产中的风险
- 智慧工地：普通摄像头可以看到高清放大
- 自动补偿放大
- 再放大，到工人的鞋子（隐私保护，一般是监测安全帽有没有佩戴）
- 化工厂的安全生产监测（普通摄像头）
