...
### 【2026-5-26】heimdall skills杀毒软件

【2026-5-26】heimdall 海姆达尔：The Watchman of Asgard - Security Scanner for AI Agent Skills 阿斯加德守望者 —— 面向 AI Agent 技能的安全扫描器
- [heimdall](https://github.com/h-mascot/heimdall)

AI Agent 生态安全工具的项目 / 产品名，核心定位是：给 AI Agent 装 “杀毒软件”，专门扫描和审计第三方技能（Skills）是否藏毒、越权、偷数据或可被劫持

面向 AI Agent Skills 的安全扫描工具。`海姆达尔`可在安装前检测 OpenClaw 技能及智能体工具包中的恶意特征。
- 结合上下文感知扫描与 AI 驱动的语义分析，精准识别高阶威胁。
- AI 智能体拥有高权限、密钥及文件系统访问权限，一个恶意技能便足以引发安全事故
- 适用于：OpenClaw Skills · MCP Tools · Agent Workflows · ClawHub Packages
