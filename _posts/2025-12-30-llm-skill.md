...
【2026-6-24】
- [SkillOpt 让技能文档像模型参数一样自动进化](https://zhuanlan.zhihu.com/p/2042712632357041905)
- [微软开源 SkillOpt：像训练神经网络一样训练智能体技能，零权重修改！](https://cloud.tencent.com/developer/article/2679922)

SkillOpt 的优雅之处: 意识到前沿模型已经被冻住了，但文本技能是可以被求导的。

它把传统 ML 整套优化哲学——前向传播收集证据、反向传播更新参数、学习率控制步长、验证集早停——完美平移到自然语言空间，产出的却是一个人人都能读懂的 .md 文件。
...
SkillOpt 最漂亮的地方，把 DL 训练的核心概念一对一刻进了文本世界：
...
整个过程中，目标模型的权重一动不动，所有优化都发生在几百到一两千个 token 的文本文件上。
...
总结：TextGrad 更像一个通用文本微分框架，SkillOpt 是一个专为 Agent 技能优化设计的、面向生产的整合方案。
