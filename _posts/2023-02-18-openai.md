...
categories: 大模型
tags: OpenAI ChatGPT AI 微调 吴恩达 虚拟号 接码 langchain 搜索
...
【2025-3-5】 [Open Deep Research](https://github.com/dzhng/deep-research) 是一个 AI 驱动的**研究助手**，通过搜索引擎、网络爬虫和大语言模型进行迭代式深度研究。提供简单的深度研究代理实现，保持代码量小于 500 行以便理解和拓展。
