...
categories: 编程语言
tags: linux shell bat windows ubuntu
...
- 参考 [问题：source: not found]([https://blog.csdn.net/qq_42584562/article/details/145033847](https://www.oryoy.com/news/ubuntu-xi-tong-wei-he-mei-you-source-yi-tan-jiu-jing-de-jie-jue-zhi-dao.html))
...
- （2）shell文件头部注明bash路径（ `#!/bin/bash` ），提示使用bash执行
